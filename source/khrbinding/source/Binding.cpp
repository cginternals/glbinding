...
#ifdef KHRBINDING_USE_BOOST_THREAD
...
KHRBINDING_THREAD_LOCAL khrbinding::ContextHandle t_context = 0;
KHRBINDING_THREAD_LOCAL khrbinding::Binding::GetProcAddress t_getProcAddress = nullptr;

std_boost::recursive_mutex g_mutex;
std::unordered_map<khrbinding::ContextHandle, int> g_bindings;
khrbinding::Binding::GetProcAddress g_firstGetProcAddress = nullptr;
