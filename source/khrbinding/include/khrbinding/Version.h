...
*  Example code:
*  \code{.cpp}
*  const khrbinding::Version currentVersion = khrbinding::ContextInfo::version();
*
*  if (currentVersion >= khrbinding::Version(3, 2))
*  {
*      // do something
*  }
*  \endcode
...
public:
    ...
    */
    KHRBINDING_CONSTEXPR inline Version(const Version & version);
    ...
    */
    KHRBINDING_CONSTEXPR inline bool operator<(const Version & version) const;
    ...
    */
    KHRBINDING_API std::string toString() const;
    ...
    */
    KHRBINDING_API bool isValid() const;
    ...
    */
    KHRBINDING_API const Version & nearest() const;
    ...
    */
    KHRBINDING_API static const std::set<Version> & versions();
    ...
    */
    KHRBINDING_API static const std::set<Version> preceeding(const Version & version);
    ...
    */
    KHRBINDING_API static const std::set<Version> succeeding(const Version & version);
    ...
    */
    KHRBINDING_API static const Version & latest();
...
*/
KHRBINDING_API std::ostream & operator<<(std::ostream & stream, const khrbinding::Version & version);
