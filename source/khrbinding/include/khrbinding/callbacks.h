...
*/
KHRBINDING_API void setCallbackMask(CallbackMask mask);
...
*/
KHRBINDING_API void setCallbackMaskExcept(CallbackMask mask, const std::set<std::string> & blackList);
...
*/
KHRBINDING_API void addCallbackMask(CallbackMask mask);
...
*    The blacklist of functions to exclude in this update
*/
KHRBINDING_API void addCallbackMaskExcept(CallbackMask mask, const std::set<std::string> & blackList);
...
*/
KHRBINDING_API void removeCallbackMask(CallbackMask mask);
...
*    The blacklist of functions to exclude in this update
*/
KHRBINDING_API void removeCallbackMaskExcept(CallbackMask mask, const std::set<std::string> & blackList);
...
*/
KHRBINDING_API SimpleFunctionCallback unresolvedCallback();
...
*/
KHRBINDING_API void setUnresolvedCallback(SimpleFunctionCallback callback);
...
*    Keep in mind that in addition to a registered callback, the callback mask of the current Function has to include the After flag to enable the callback
*/
KHRBINDING_API FunctionCallback beforeCallback();
...
*/
KHRBINDING_API void setBeforeCallback(FunctionCallback callback);
...
*    Keep in mind that in addition to a registered callback, the callback mask of the current Function has to include the After flag to enable the callback
*/
KHRBINDING_API FunctionCallback afterCallback();
...
*    Keep in mind that in addition to a registered callback, the callback mask of the current Function has to include the After flag to enable the callback
*/
KHRBINDING_API void setAfterCallback(FunctionCallback callback);
