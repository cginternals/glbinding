...
KHRBINDING_CONSTEXPR Version::Version()
: m_major(0)
, m_minor(0)
{
}

KHRBINDING_CONSTEXPR Version::Version(unsigned char majorVersion, unsigned char minorVersion)
: m_major(majorVersion)
, m_minor(minorVersion)
{
}

KHRBINDING_CONSTEXPR Version::Version(const Version & version)
...
KHRBINDING_CONSTEXPR bool Version::operator<(const Version & version) const
{
...
KHRBINDING_CONSTEXPR unsigned char Version::majorVersion() const
{
    return m_major;
}

KHRBINDING_CONSTEXPR unsigned char Version::minorVersion() const
{
    return m_minor;
}
...
KHRBINDING_CONSTEXPR bool Version::isNull() const
{
    return m_major == 0;
}
