...
*/
GLESBINDING_API void resize(unsigned int newSize);
...
*/
GLESBINDING_API void start(const std::string & filepath);
...
*    This function generates a file name and uses this as output
*/
GLESBINDING_API void startExcept(const std::set<std::string> & blackList);
...
*    The blacklist of function names
*/
GLESBINDING_API void startExcept(const std::string & filepath, const std::set<std::string> & blackList);

/**
*  @brief
*    Stops logging and flushing log file
*/
GLESBINDING_API void stop();
...
*/
GLESBINDING_API void pause();

/**
*  @brief
*    Resumes paused logging
*/
GLESBINDING_API void resume();
...
*
*  @remarks
*    This function is intended to get used by glesbinding and not by a user of glesbinding
*/
GLESBINDING_API void log(LogEntry call);
