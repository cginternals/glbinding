...
using gles2::GL_TEXTURE_WIDTH;
using gles2::GL_TEXTURE_HEIGHT;
using gles2::GL_TEXTURE_INTERNAL_FORMAT;
...
using gles2::GL_TEXTURE_RED_SIZE;
using gles2::GL_TEXTURE_GREEN_SIZE;
using gles2::GL_TEXTURE_BLUE_SIZE;
using gles2::GL_TEXTURE_ALPHA_SIZE;
...
using gles2::GL_PROGRAM_SEPARABLE;
using gles2::GL_ACTIVE_PROGRAM;
using gles2::GL_PROGRAM_PIPELINE_BINDING;
using gles2::GL_MAX_COMPUTE_SHARED_MEMORY_SIZE;
using gles2::GL_MAX_COMPUTE_UNIFORM_COMPONENTS;
using gles2::GL_MAX_COMPUTE_ATOMIC_COUNTER_BUFFERS;
using gles2::GL_MAX_COMPUTE_ATOMIC_COUNTERS;
using gles2::GL_MAX_COMBINED_COMPUTE_UNIFORM_COMPONENTS;
using gles2::GL_COMPUTE_WORK_GROUP_SIZE;
using gles2::GL_MAX_UNIFORM_LOCATIONS;
using gles2::GL_VERTEX_ATTRIB_BINDING;
using gles2::GL_VERTEX_ATTRIB_RELATIVE_OFFSET;
using gles2::GL_VERTEX_BINDING_DIVISOR;
using gles2::GL_VERTEX_BINDING_OFFSET;
using gles2::GL_VERTEX_BINDING_STRIDE;
using gles2::GL_MAX_VERTEX_ATTRIB_RELATIVE_OFFSET;
using gles2::GL_MAX_VERTEX_ATTRIB_BINDINGS;
using gles2::GL_TEXTURE_IMMUTABLE_LEVELS;
using gles2::GL_MAX_VERTEX_ATTRIB_STRIDE;
...
using gles2::GL_TEXTURE_COMPRESSED;
...
using gles2::GL_TEXTURE_DEPTH_SIZE;
...
using gles2::GL_READ_ONLY;
using gles2::GL_WRITE_ONLY;
using gles2::GL_READ_WRITE;
...
using gles2::GL_TEXTURE_STENCIL_SIZE;
...
using gles2::GL_TEXTURE_RED_TYPE;
using gles2::GL_TEXTURE_GREEN_TYPE;
using gles2::GL_TEXTURE_BLUE_TYPE;
using gles2::GL_TEXTURE_ALPHA_TYPE;
using gles2::GL_TEXTURE_DEPTH_TYPE;
...
using gles2::GL_TEXTURE_SHARED_SIZE;
using gles2::GL_SRGB;
...
using gles2::GL_SAMPLE_POSITION;
using gles2::GL_SAMPLE_MASK;
using gles2::GL_SAMPLE_MASK_VALUE;
using gles2::GL_MAX_SAMPLE_MASK_WORDS;
using gles2::GL_MIN_PROGRAM_TEXTURE_GATHER_OFFSET;
using gles2::GL_MAX_PROGRAM_TEXTURE_GATHER_OFFSET;
...
using gles2::GL_MAX_IMAGE_UNITS;
using gles2::GL_MAX_COMBINED_SHADER_OUTPUT_RESOURCES;
using gles2::GL_IMAGE_BINDING_NAME;
using gles2::GL_IMAGE_BINDING_LEVEL;
using gles2::GL_IMAGE_BINDING_LAYERED;
using gles2::GL_IMAGE_BINDING_LAYER;
using gles2::GL_IMAGE_BINDING_ACCESS;
using gles2::GL_DRAW_INDIRECT_BUFFER;
using gles2::GL_DRAW_INDIRECT_BUFFER_BINDING;
using gles2::GL_VERTEX_BINDING_BUFFER;
...
using gles2::GL_IMAGE_2D;
using gles2::GL_IMAGE_3D;
using gles2::GL_IMAGE_CUBE;
using gles2::GL_IMAGE_2D_ARRAY;
using gles2::GL_INT_IMAGE_2D;
using gles2::GL_INT_IMAGE_3D;
using gles2::GL_INT_IMAGE_CUBE;
using gles2::GL_INT_IMAGE_2D_ARRAY;
using gles2::GL_UNSIGNED_INT_IMAGE_2D;
using gles2::GL_UNSIGNED_INT_IMAGE_3D;
using gles2::GL_UNSIGNED_INT_IMAGE_CUBE;
using gles2::GL_UNSIGNED_INT_IMAGE_2D_ARRAY;
using gles2::GL_IMAGE_BINDING_FORMAT;
using gles2::GL_RGB10_A2UI;
using gles2::GL_IMAGE_FORMAT_COMPATIBILITY_TYPE;
using gles2::GL_IMAGE_FORMAT_COMPATIBILITY_BY_SIZE;
using gles2::GL_IMAGE_FORMAT_COMPATIBILITY_BY_CLASS;
using gles2::GL_MAX_VERTEX_IMAGE_UNIFORMS;
using gles2::GL_MAX_FRAGMENT_IMAGE_UNIFORMS;
using gles2::GL_MAX_COMBINED_IMAGE_UNIFORMS;
using gles2::GL_SHADER_STORAGE_BUFFER;
using gles2::GL_SHADER_STORAGE_BUFFER_BINDING;
using gles2::GL_SHADER_STORAGE_BUFFER_START;
using gles2::GL_SHADER_STORAGE_BUFFER_SIZE;
using gles2::GL_MAX_VERTEX_SHADER_STORAGE_BLOCKS;
using gles2::GL_MAX_FRAGMENT_SHADER_STORAGE_BLOCKS;
using gles2::GL_MAX_COMPUTE_SHADER_STORAGE_BLOCKS;
using gles2::GL_MAX_COMBINED_SHADER_STORAGE_BLOCKS;
using gles2::GL_MAX_SHADER_STORAGE_BUFFER_BINDINGS;
using gles2::GL_MAX_SHADER_STORAGE_BLOCK_SIZE;
using gles2::GL_SHADER_STORAGE_BUFFER_OFFSET_ALIGNMENT;
using gles2::GL_DEPTH_STENCIL_TEXTURE_MODE;
using gles2::GL_MAX_COMPUTE_WORK_GROUP_INVOCATIONS;
using gles2::GL_DISPATCH_INDIRECT_BUFFER;
using gles2::GL_DISPATCH_INDIRECT_BUFFER_BINDING;
using gles2::GL_TEXTURE_2D_MULTISAMPLE;
using gles2::GL_TEXTURE_BINDING_2D_MULTISAMPLE;
using gles2::GL_TEXTURE_SAMPLES;
using gles2::GL_TEXTURE_FIXED_SAMPLE_LOCATIONS;
using gles2::GL_SAMPLER_2D_MULTISAMPLE;
using gles2::GL_INT_SAMPLER_2D_MULTISAMPLE;
using gles2::GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE;
using gles2::GL_MAX_COLOR_TEXTURE_SAMPLES;
using gles2::GL_MAX_DEPTH_TEXTURE_SAMPLES;
using gles2::GL_MAX_INTEGER_SAMPLES;
...
using gles2::GL_COMPUTE_SHADER;
using gles2::GL_MAX_COMPUTE_UNIFORM_BLOCKS;
using gles2::GL_MAX_COMPUTE_TEXTURE_IMAGE_UNITS;
using gles2::GL_MAX_COMPUTE_IMAGE_UNIFORMS;
using gles2::GL_MAX_COMPUTE_WORK_GROUP_COUNT;
using gles2::GL_MAX_COMPUTE_WORK_GROUP_SIZE;
...
using gles2::GL_ATOMIC_COUNTER_BUFFER;
using gles2::GL_ATOMIC_COUNTER_BUFFER_BINDING;
using gles2::GL_ATOMIC_COUNTER_BUFFER_START;
using gles2::GL_ATOMIC_COUNTER_BUFFER_SIZE;
using gles2::GL_MAX_VERTEX_ATOMIC_COUNTER_BUFFERS;
using gles2::GL_MAX_FRAGMENT_ATOMIC_COUNTER_BUFFERS;
using gles2::GL_MAX_COMBINED_ATOMIC_COUNTER_BUFFERS;
using gles2::GL_MAX_VERTEX_ATOMIC_COUNTERS;
using gles2::GL_MAX_FRAGMENT_ATOMIC_COUNTERS;
using gles2::GL_MAX_COMBINED_ATOMIC_COUNTERS;
using gles2::GL_MAX_ATOMIC_COUNTER_BUFFER_SIZE;
using gles2::GL_ACTIVE_ATOMIC_COUNTER_BUFFERS;
using gles2::GL_UNSIGNED_INT_ATOMIC_COUNTER;
using gles2::GL_MAX_ATOMIC_COUNTER_BUFFER_BINDINGS;
using gles2::GL_UNIFORM;
using gles2::GL_UNIFORM_BLOCK;
using gles2::GL_PROGRAM_INPUT;
using gles2::GL_PROGRAM_OUTPUT;
using gles2::GL_BUFFER_VARIABLE;
using gles2::GL_SHADER_STORAGE_BLOCK;
using gles2::GL_TRANSFORM_FEEDBACK_VARYING;
using gles2::GL_ACTIVE_RESOURCES;
using gles2::GL_MAX_NAME_LENGTH;
using gles2::GL_MAX_NUM_ACTIVE_VARIABLES;
using gles2::GL_NAME_LENGTH;
using gles2::GL_TYPE;
using gles2::GL_ARRAY_SIZE;
using gles2::GL_OFFSET;
using gles2::GL_BLOCK_INDEX;
using gles2::GL_ARRAY_STRIDE;
using gles2::GL_MATRIX_STRIDE;
using gles2::GL_IS_ROW_MAJOR;
using gles2::GL_ATOMIC_COUNTER_BUFFER_INDEX;
using gles2::GL_BUFFER_BINDING;
using gles2::GL_BUFFER_DATA_SIZE;
using gles2::GL_NUM_ACTIVE_VARIABLES;
using gles2::GL_ACTIVE_VARIABLES;
using gles2::GL_REFERENCED_BY_VERTEX_SHADER;
using gles2::GL_REFERENCED_BY_FRAGMENT_SHADER;
using gles2::GL_REFERENCED_BY_COMPUTE_SHADER;
using gles2::GL_TOP_LEVEL_ARRAY_SIZE;
using gles2::GL_TOP_LEVEL_ARRAY_STRIDE;
using gles2::GL_LOCATION;
using gles2::GL_FRAMEBUFFER_DEFAULT_WIDTH;
using gles2::GL_FRAMEBUFFER_DEFAULT_HEIGHT;
using gles2::GL_FRAMEBUFFER_DEFAULT_SAMPLES;
using gles2::GL_FRAMEBUFFER_DEFAULT_FIXED_SAMPLE_LOCATIONS;
using gles2::GL_MAX_FRAMEBUFFER_WIDTH;
using gles2::GL_MAX_FRAMEBUFFER_HEIGHT;
using gles2::GL_MAX_FRAMEBUFFER_SAMPLES;
