...
// using gles::GL_ZERO; // reuse BlendingFactorDest
// using gles::GL_SRC_ALPHA; // reuse BlendingFactorDest
// using gles::GL_ONE_MINUS_SRC_ALPHA; // reuse BlendingFactorDest
// using gles::GL_DST_ALPHA; // reuse BlendingFactorDest
// using gles::GL_ONE_MINUS_DST_ALPHA; // reuse BlendingFactorDest
using gles::GL_DST_COLOR;
using gles::GL_ONE_MINUS_DST_COLOR;
using gles::GL_SRC_ALPHA_SATURATE;
// using gles::GL_ONE; // reuse BlendingFactorDest
...
// using gles::GL_FRONT; // reuse ColorMaterialFace
// using gles::GL_BACK; // reuse ColorMaterialFace
// using gles::GL_FRONT_AND_BACK; // reuse ColorMaterialFace
...
// using gles::GL_NONE; // reuse DrawBufferMode
// using gles::GL_RGB; // reuse PixelFormat
// using gles::GL_RGBA; // reuse PixelFormat
...
// using gles::GL_LINEAR; // reuse FogMode

// TextureMinFilter

// using gles::GL_NEAREST; // reuse TextureMagFilter
// using gles::GL_LINEAR; // reuse FogMode
