...
public:
    ...
    *
    *  @return
    *    The list of available extensions known by glesbinding
    */
    ...
    *    The list of extension names for available extensions not known by glesbinding
    *
    *  @return
    *    The list of available extensions known by glesbinding
    *
    ...
    */
    GLESBINDING_DEPRECATED static std::set<gles::GLextension> extensions(std::set<std::string> * unknown);
    ...
    *    The list of available extensions known by glesbinding
    */
    static std::set<gles::GLextension> extensions(std::set<std::string> & unknown);
    ...
    */
    static bool supported(const std::set<gles::GLextension> & extensions);
    ...
    *    'true' if all given extensions are supported by the current context, else 'false'
    */
    static bool supported(const std::set<gles::GLextension> & extensions , std::set<gles::GLextension> & unsupported);
