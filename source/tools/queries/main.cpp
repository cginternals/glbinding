...
int main(int argc, const char * argv[])
{
	...
	requestState<GLfloat, 4>(GL_CURRENT_NORMAL, { { 0, 0, 1 } });
	...
	requestState<GLint, 1>(GL_MAX_VIEWPORTS, { { 16 } });
	requestState<GLfloat, 2>(GL_VIEWPORT_BOUNDS_RANGE, { { -32768, 32767 } });
	requestState<GLint, 1>(GL_VIEWPORT_SUBPIXEL_BITS, { { 0 } });
	...
	requestState<GLenum, 2>(GL_POLYGON_MODE, { { GL_FILL } });
	...
	requestState<GLint, 1>(GL_DEPTH_CLEAR_VALUE, { { 1 } });
	...
	requestState<GLint, 1>(GL_MAX_LIGHTS, { { 8 } });
	requestState<GLint, 1>(GL_MAX_MODELVIEW_STACK_DEPTH, { { 32 } });
	requestState<GLint, 1>(GL_MAX_PROJECTION_STACK_DEPTH, { { 2 } });
	requestState<GLint, 1>(GL_MAX_TEXTURE_STACK_DEPTH, { { 2 } });
	requestState<GLint, 1>(GL_SUBPIXEL_BITS, { { 4 } });
	requestState<GLint, 1>(GL_MAX_TEXTURE_SIZE, { { 64 } });
	requestState<GLint, 1>(GL_MAX_PIXEL_MAP_TABLE, { { 32 } });
	requestState<GLint, 1>(GL_MAX_NAME_STACK_DEPTH, { { 64 } });
	requestState<GLint, 1>(GL_MAX_LIST_NESTING, { { 64 } });
	requestState<GLint, 1>(GL_MAX_EVAL_ORDER, { { 8 } });
	requestState<GLint, 1>(GL_MAX_ATTRIB_STACK_DEPTH, { { 16 } });
	requestState<GLint, 1>(GL_MAX_CLIENT_ATTRIB_STACK_DEPTH, { { 16 } });
	requestState<GLint, 1>(GL_AUX_BUFFERS, { { 0 } });
	...
	requestState<GLfloat, 2>(GL_POINT_SIZE_RANGE, { { 1, 1 } });
	requestState<GLfloat, 1>(GL_POINT_SIZE_GRANULARITY);
	requestState<GLfloat, 2>(GL_LINE_WIDTH_RANGE, { { 1, 1 } });
	...
	requestState<GLint, 1>(GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS, { { 48 } });
	...
	requestState<GLint, 1>(GL_MAX_DUAL_SOURCE_DRAW_BUFFERS, { { 1 } });
	...
	requestState<GLint, 1>(GL_MAX_COMBINED_COMPUTE_UNIFORM_COMPONENTS, { { 1 } });
	requestState<GLint, 1>(GL_MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS, { { 1 } });
	requestState<GLint, 1>(GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS, { { 1 } });
	requestState<GLint, 1>(GL_MAX_COMBINED_UNIFORM_BLOCKS, { { 70 } });
	requestState<GLint, 1>(GL_MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS, { { 1 } });
	...
	requestState<GLint, 1>(GL_MAX_COMPUTE_TEXTURE_IMAGE_UNITS, { { 16 } });
	requestState<GLint, 1>(GL_MAX_COMPUTE_UNIFORM_BLOCKS, { { 14 } });
	requestState<GLint, 1>(GL_MAX_COMPUTE_UNIFORM_COMPONENTS, { { 1 } });
	...
	requestState<GLint, 1>(GL_MAX_DRAW_BUFFERS, { { 8 } });
	...
	requestState<GLint, 1>(GL_MAX_FRAGMENT_INPUT_COMPONENTS, { { 128 } });
	requestState<GLint, 1>(GL_MAX_FRAGMENT_SHADER_STORAGE_BLOCKS);
	requestState<GLint, 1>(GL_MAX_FRAGMENT_UNIFORM_BLOCKS, { { 12 } });
	requestState<GLint, 1>(GL_MAX_FRAGMENT_UNIFORM_COMPONENTS, { { 1024 } });
	requestState<GLint, 1>(GL_MAX_FRAGMENT_UNIFORM_VECTORS, { { 256 } });

	std::cout << std::endl << "Framebuffer Parameter States" << std::endl;
	requestState<GLint, 1>(GL_MAX_FRAMEBUFFER_HEIGHT, { { 16384 } });
	requestState<GLint, 1>(GL_MAX_FRAMEBUFFER_LAYERS, { { 2048 } });
	requestState<GLint, 1>(GL_MAX_FRAMEBUFFER_SAMPLES, { { 4 } });
	requestState<GLint, 1>(GL_MAX_FRAMEBUFFER_WIDTH, { { 16384 } });

	std::cout << std::endl << "Geometry Shader States" << std::endl;
	requestState<GLint, 1>(GL_MAX_GEOMETRY_ATOMIC_COUNTERS);
	requestState<GLint, 1>(GL_MAX_GEOMETRY_INPUT_COMPONENTS, { { 64 } });
	requestState<GLint, 1>(GL_MAX_GEOMETRY_OUTPUT_COMPONENTS, { { 128 } });
	requestState<GLint, 1>(GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS);
	requestState<GLint, 1>(GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS, { { 16 } });
	requestState<GLint, 1>(GL_MAX_GEOMETRY_UNIFORM_BLOCKS, { { 12 } });
	requestState<GLint, 1>(GL_MAX_GEOMETRY_UNIFORM_COMPONENTS, { { 1024 } });

	std::cout << std::endl << "Texel Offset States" << std::endl;
	requestState<GLint, 1>(GL_MAX_PROGRAM_TEXEL_OFFSET, { { 7 } });
	requestState<GLint, 1>(GL_MIN_PROGRAM_TEXEL_OFFSET, { { -8 } });
	...
	requestState<GLint, 1>(GL_MAX_TEXTURE_BUFFER_SIZE, { { 65536 } });
	requestState<GLfloat, 1>(GL_MAX_TEXTURE_IMAGE_UNITS, { { 16 } });
	requestState<GLfloat, 1>(GL_MAX_TEXTURE_LOD_BIAS, { { 2.0f } });
	requestState<GLint, 1>(GL_MAX_TEXTURE_UNITS, { { 1024 } });
	...
	requestState<GLint, 1>(GL_MAX_VERTEX_ATTRIBS, { { 16 } });
	requestState<GLint, 1>(GL_MAX_VERTEX_OUTPUT_COMPONENTS, { { 64 } });
	requestState<GLint, 1>(GL_MAX_VERTEX_SHADER_STORAGE_BLOCKS);
	requestState<GLint, 1>(GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS, { { 16 } });
	requestState<GLint, 1>(GL_MAX_VERTEX_UNIFORM_BLOCKS, { { 12 } });
	requestState<GLint, 1>(GL_MAX_VERTEX_UNIFORM_COMPONENTS, { { 1024 } });
	requestState<GLint, 1>(GL_MAX_VERTEX_UNIFORM_VECTORS, { { 256 } });
	...
	requestState<GLfloat, 1>(GL_POINT_SIZE_MAX, { { 0.0 } });
	requestState<GLfloat, 1>(GL_POINT_SIZE_MIN, { { 1.0 } });
	...
	requestState<GLdouble, 16>(GL_TRANSPOSE_COLOR_MATRIX);
	requestState<GLdouble, 16>(GL_TRANSPOSE_MODELVIEW_MATRIX);
	requestState<GLdouble, 16>(GL_TRANSPOSE_PROJECTION_MATRIX);
	requestState<GLdouble, 16>(GL_TRANSPOSE_TEXTURE_MATRIX);
	...
	requestState<GLdouble, 1>(GL_CURRENT_FOG_COORD, { { 0 } });
	...
	requestState<GLint, 1>(GL_MAX_3D_TEXTURE_SIZE, { { 64 } });
	requestState<GLint, 1>(GL_MAX_ARRAY_TEXTURE_LAYERS, { { 256 } });
	requestState<GLfloat, 1>(GL_MAX_CLIP_DISTANCES, { { 8 } });
	...
	requestState<GLint, 1>(GL_MAX_CUBE_MAP_TEXTURE_SIZE, { { 1024 } });
	...
	requestState<GLint, 1>(GL_MAX_RECTANGLE_TEXTURE_SIZE, { { 1024 } });
	...
	requestState<GLint, 1>(GL_MAX_SHADER_STORAGE_BUFFER_BINDINGS, { { 8 } });
	requestState<GLint, 1>(GL_MAX_UNIFORM_BLOCK_SIZE, { { 16384 } });
	requestState<GLint, 1>(GL_MAX_UNIFORM_BUFFER_BINDINGS, { { 36 } });
	requestState<GLint, 1>(GL_MAX_UNIFORM_LOCATIONS, { { 1024 } });
	requestState<GLint, 1>(GL_MAX_VARYING_COMPONENTS, { { 60 } });
	requestState<GLint, 1>(GL_MAX_VARYING_FLOATS, { { 32 } });
	requestState<GLint, 1>(GL_MAX_VARYING_VECTORS, { { 15 } });
	...
	requestState<GLint, 1>(GL_NUM_COMPRESSED_TEXTURE_FORMATS, { { 4 } });
