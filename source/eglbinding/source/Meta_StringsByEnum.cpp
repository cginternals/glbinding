...
const std::unordered_map<EGLenum, std::string> Meta_StringsByEnum
{
    ...
    { EGLenum::EGL_NO_CONTEXT, "EGL_NO_CONTEXT" },
    { EGLenum::EGL_NO_DEVICE_EXT, "EGL_NO_DEVICE_EXT" },
    { EGLenum::EGL_NO_DISPLAY, "EGL_NO_DISPLAY" },
    { EGLenum::EGL_NO_IMAGE, "EGL_NO_IMAGE" },
    { EGLenum::EGL_NO_IMAGE_KHR, "EGL_NO_IMAGE_KHR" },
    { EGLenum::EGL_DEFAULT_DISPLAY, "EGL_DEFAULT_DISPLAY" },
    { EGLenum::EGL_NO_FILE_DESCRIPTOR_KHR, "EGL_NO_FILE_DESCRIPTOR_KHR" },
    { EGLenum::EGL_NO_OUTPUT_LAYER_EXT, "EGL_NO_OUTPUT_LAYER_EXT" },
    { EGLenum::EGL_NO_OUTPUT_PORT_EXT, "EGL_NO_OUTPUT_PORT_EXT" },
    { EGLenum::EGL_NO_STREAM_KHR, "EGL_NO_STREAM_KHR" },
    { EGLenum::EGL_NO_SURFACE, "EGL_NO_SURFACE" },
    { EGLenum::EGL_NO_SYNC, "EGL_NO_SYNC" },
    { EGLenum::EGL_NO_SYNC_KHR, "EGL_NO_SYNC_KHR" },
    { EGLenum::EGL_NO_SYNC_NV, "EGL_NO_SYNC_NV" },
    { EGLenum::EGL_DONT_CARE, "EGL_DONT_CARE" },
    { EGLenum::EGL_NO_NATIVE_FENCE_FD_ANDROID, "EGL_NO_NATIVE_FENCE_FD_ANDROID" },
    { EGLenum::EGL_DEPTH_ENCODING_NONE_NV, "EGL_DEPTH_ENCODING_NONE_NV" },
