...
*/
EGLBINDING_CONSTEXPR inline CallbackMask operator~(CallbackMask a);
...
*/
EGLBINDING_CONSTEXPR inline CallbackMask operator|(CallbackMask a, CallbackMask b);
...
#include <eglbinding/CallbackMask.inl>
