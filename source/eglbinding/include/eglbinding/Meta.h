...
public:
    ...
    */
    static egl::GLbitfield getBitfield(const std::string & bitfield);
    ...
    */
    static std::vector<egl::GLbitfield> bitfields();
    ...
    */
    static const std::string & getString(egl::GLenum glenum);
    ...
    */
    static egl::GLenum getEnum(const std::string & glenum);
    ...
    */
    static std::vector<egl::GLenum> enums();
    ...
    */
    static const std::string & getString(const egl::GLboolean & glboolean);
    ...
    */
    static egl::GLboolean getBoolean(const std::string & glboolean);
    ...
    */
    static const std::string & getString(egl::GLextension glextension);
    ...
    */
    static egl::GLextension getExtension(const std::string & glextension);
    ...
    */
    static std::set<egl::GLextension> extensions();
    ...
    */
    static const std::set<egl::GLextension> extensions(const Version & version);
    ...
    */
    static const std::set<egl::GLextension> extensions(const std::string & glfunction);
    ...
    */
    static const std::set<AbstractFunction *> functions(egl::GLextension glextension);
    ...
    */
    static const Version & version(egl::GLextension glextension);
