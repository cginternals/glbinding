...
public:
    ...
    static khrapi::Function<Binding, egl::EGLBoolean, egl::EGLDisplay, egl::EGLImageKHR, egl::int *, egl::EGLint *, egl::EGLint *> ExportDMABUFImageMESA;
    static khrapi::Function<Binding, egl::EGLBoolean, egl::EGLDisplay, egl::EGLImageKHR, egl::int *, egl::int *, egl::EGLuint64KHR *> ExportDMABUFImageQueryMESA;
    ...
    static khrapi::Function<Binding, egl::__eglMustCastToProperFunctionPointerType, const egl::char *> GetProcAddress;
    ...
    static khrapi::Function<Binding, const egl::char *, egl::EGLDeviceEXT, egl::EGLint> QueryDeviceStringEXT;
    ...
    static khrapi::Function<Binding, const egl::char *, egl::EGLDisplay, egl::EGLOutputLayerEXT, egl::EGLint> QueryOutputLayerStringEXT;
    ...
    static khrapi::Function<Binding, const egl::char *, egl::EGLDisplay, egl::EGLOutputPortEXT, egl::EGLint> QueryOutputPortStringEXT;
    ...
    static khrapi::Function<Binding, const egl::char *, egl::EGLDisplay, egl::EGLint> QueryString;
