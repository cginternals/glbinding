...
EGLBINDING_CONSTEXPR AbstractVersion::AbstractVersion()
: m_major(0)
, m_minor(0)
{
}

EGLBINDING_CONSTEXPR AbstractVersion::AbstractVersion(unsigned char majorVersion, unsigned char minorVersion)
: m_major(majorVersion)
, m_minor(minorVersion)
{
}

EGLBINDING_CONSTEXPR unsigned char AbstractVersion::majorVersion() const
{
    return m_major;
}

EGLBINDING_CONSTEXPR unsigned char AbstractVersion::minorVersion() const
{
    return m_minor;
}
...
EGLBINDING_CONSTEXPR bool AbstractVersion::isNull() const
{
    return m_major == 0;
}
