...
class EGLBINDING_TEMPLATE_API SharedBitfield;
...
struct EGLBINDING_TEMPLATE_API is_member_of_SharedBitfield
{
...
struct EGLBINDING_TEMPLATE_API is_member_of_SharedBitfield<T, U, Types...>
{
...
struct EGLBINDING_TEMPLATE_API prepend_to_SharedBitfield
{
};
...
*/
template<typename T, typename... Types>
struct EGLBINDING_TEMPLATE_API prepend_to_SharedBitfield<T, SharedBitfield<Types...>>
{
...
*/
template<typename, typename>
struct EGLBINDING_TEMPLATE_API intersect_SharedBitfield
{
...
struct EGLBINDING_TEMPLATE_API intersect_SharedBitfield<SharedBitfield<T, Types...>, SharedBitfield<OtherTypes...>>
{
...
*/
template <typename T>
class EGLBINDING_TEMPLATE_API SharedBitfieldBase
{
public:
    ...
    */
    EGLBINDING_CONSTEXPR inline SharedBitfieldBase(T value);
    ...
    *    The bitfield value
    */
    EGLBINDING_CONSTEXPR inline explicit operator T() const;
...
class EGLBINDING_TEMPLATE_API SharedBitfield<Type> : public SharedBitfieldBase<typename std::underlying_type<Type>::type>
{
public:
    ...
    */
    ...
    EGLBINDING_CONSTEXPR inline SharedBitfield(ConstructionType value);
    ...
    *    The value of this SharedBitfield
    */
    EGLBINDING_CONSTEXPR inline SharedBitfield(typename std::underlying_type<Type>::type value);
    ...
    */
    EGLBINDING_CONSTEXPR inline operator Type() const;
    ...
    */
    template <typename... T>
    EGLBINDING_CONSTEXPR inline auto operator|(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type>::type;
    ...
    */
    template <typename... T>
    EGLBINDING_CONSTEXPR inline auto operator==(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, bool>::type;
    ...
    */
    template <typename T>
    EGLBINDING_CONSTEXPR inline auto operator==(T other) const -> typename std::enable_if<is_member_of_SharedBitfield<T, Type>::value, bool>::type;
};
...
class EGLBINDING_TEMPLATE_API SharedBitfield<Type, Types...> : public SharedBitfield<Types...>
{
public:
    ...
    */
    template <typename... T>
    EGLBINDING_CONSTEXPR inline auto operator|(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type, Types...>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, typename intersect_SharedBitfield<SharedBitfield<Type, Types...>, SharedBitfield<T...>>::type>::type;
    ...
    */
    template <typename... T>
    EGLBINDING_CONSTEXPR inline auto operator==(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type, Types...>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, bool>::type;
    ...
    */
    template <typename T>
    EGLBINDING_CONSTEXPR inline auto operator==(T other) const -> typename std::enable_if<is_member_of_SharedBitfield<T, Type, Types...>::value, bool>::type;
};
...
EGLBINDING_CONSTEXPR inline typename std::enable_if<std::is_base_of<SharedBitfieldBase<typename std::underlying_type<typename std::enable_if<std::is_enum<Enum>::value, Enum>::type>::type>, ConvertibleEnum>::value, Enum>::type
...
#include <eglbinding/SharedBitfield.inl>
