...
public:
    ...
    */
    {{ucbinding}}_CONSTEXPR inline AbstractVersion();
    ...
    *    The minor version
    */
    {{ucbinding}}_CONSTEXPR inline AbstractVersion(unsigned char majorVersion, unsigned char minorVersion);
    ...
    */
    {{ucbinding}}_CONSTEXPR inline AbstractVersion(const AbstractVersion & version) = delete;
...
#include <{{binding}}/AbstractVersion.inl>
