...
#  elif GLBINDING_COMPILER_IS_GNU || GLBINDING_COMPILER_IS_Clang || GLBINDING_COMPILER_IS_AppleClang || GLBINDING_COMPILER_IS_Intel
...
#  if GLBINDING_COMPILER_CXX_CONSTEXPR
