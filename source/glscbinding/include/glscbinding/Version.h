...
*  Example code:
*  \code{.cpp}
*  const glscbinding::Version currentVersion = glscbinding::ContextInfo::version();
*
...
public:
    ...
    */
    GLSCBINDING_API std::string toString() const;
    ...
    */
    GLSCBINDING_API bool isValid() const;
    ...
    */
    GLSCBINDING_API const Version & nearest() const;
    ...
    */
    GLSCBINDING_API static const std::set<Version> & versions();
    ...
    */
    GLSCBINDING_API static const std::set<Version> preceeding(const Version & version);
    ...
    */
    GLSCBINDING_API static const std::set<Version> succeeding(const Version & version);
    ...
    */
    GLSCBINDING_API static const Version & latest();
...
*/
GLSCBINDING_API std::ostream & operator<<(std::ostream & stream, const glscbinding::Version & version);
