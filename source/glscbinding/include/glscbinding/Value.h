...
/**
*  @brief
*    A specialized printOn method for the glsc::GLenum Value template
*/
template <>
GLSCBINDING_API void Value<glsc::GLenum>::printOn(std::ostream & stream) const;

///**
//*  @brief
//*    A specialized method for the glsc::GLbitfield Value template
//*/
//template <> GLSCBINDING_API void Value<glsc::GLbitfield>::printOn(std::ostream & stream) const;
...
*/
template <>
GLSCBINDING_API void Value<glsc::GLboolean>::printOn(std::ostream & stream) const;

/**
*  @brief
*    A specialized printOn method for the glsc::GLubyte * Value template
*/
template <>
GLSCBINDING_API void Value<const glsc::GLubyte *>::printOn(std::ostream & stream) const;

/**
*  @brief
*    A specialized printOn method for the glsc::GLchar * Value template
*/
template <>
GLSCBINDING_API void Value<const glsc::GLchar *>::printOn(std::ostream & stream) const;

/**
*  @brief
*    A specialized printOn method for the glsc::GLuint_array_2 Value template
*/
template <>
GLSCBINDING_API void Value<glsc::GLuint_array_2>::printOn(std::ostream & stream) const;
