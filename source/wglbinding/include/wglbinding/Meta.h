...
public:
    ...
    */
    static wgl::GLbitfield getBitfield(const std::string & bitfield);
    ...
    */
    static std::vector<wgl::GLbitfield> bitfields();
    ...
    */
    static const std::string & getString(wgl::GLenum glenum);
    ...
    */
    static wgl::GLenum getEnum(const std::string & glenum);
    ...
    */
    static std::vector<wgl::GLenum> enums();
    ...
    */
    static const std::string & getString(const wgl::GLboolean & glboolean);
    ...
    */
    static wgl::GLboolean getBoolean(const std::string & glboolean);
    ...
    */
    static const std::string & getString(wgl::GLextension glextension);
    ...
    */
    static wgl::GLextension getExtension(const std::string & glextension);
    ...
    */
    static std::set<wgl::GLextension> extensions();
    ...
    */
    static const std::set<wgl::GLextension> extensions(const Version & version);
    ...
    */
    static const std::set<wgl::GLextension> extensions(const std::string & glfunction);
    ...
    */
    static const std::set<AbstractFunction *> functions(wgl::GLextension glextension);
    ...
    */
    static const Version & version(wgl::GLextension glextension);
