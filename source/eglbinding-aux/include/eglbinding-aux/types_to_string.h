...
EGLBINDING_AUX_API std::ostream & operator<<(std::ostream & stream, const khrbinding::AbstractValue * value);
...
*/
template <>
EGLBINDING_AUX_API std::ostream & operator<<(std::ostream & stream, const Value<egl::EGLchar *> & value);
