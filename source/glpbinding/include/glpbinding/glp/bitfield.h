...
static const khrapi::SharedBitfield<glp::AttribMask, glp::BufferAccessMask, glp::BufferBitQCOM, glp::BufferStorageMask, glp::ClearBufferMask, glp::ContextFlagMask, glp::MapBufferUsageMask, glp::MemoryBarrierMask, glp::PathFontStyle, glp::PathRenderingMaskNV, glp::PerformanceQueryCapsMaskINTEL, glp::SyncObjectMask, glp::UnusedMask, glp::UseProgramStageMask> GL_NONE_BIT = glp::AttribMask::GL_NONE_BIT;
