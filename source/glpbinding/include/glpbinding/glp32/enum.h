...
using glp::GL_STACK_OVERFLOW;
using glp::GL_STACK_UNDERFLOW;
...
// using glp::GL_VERTEX_ARRAY; // reuse EnableCap
...
using glp::GL_TEXTURE_BORDER_COLOR;
...
using glp::GL_QUADS;
using glp::GL_LINES_ADJACENCY;
using glp::GL_LINE_STRIP_ADJACENCY;
using glp::GL_TRIANGLES_ADJACENCY;
using glp::GL_TRIANGLE_STRIP_ADJACENCY;
using glp::GL_PATCHES;
...
// using glp::GL_TEXTURE_BORDER_COLOR; // reuse GetTextureParameter
...
using glp::GL_CONTEXT_FLAGS;
using glp::GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED;
using glp::GL_RG;
...
using glp::GL_RG32I;
using glp::GL_RG32UI;
using glp::GL_DEBUG_OUTPUT_SYNCHRONOUS;
using glp::GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH;
using glp::GL_DEBUG_CALLBACK_FUNCTION;
using glp::GL_DEBUG_CALLBACK_USER_PARAM;
using glp::GL_DEBUG_SOURCE_API;
using glp::GL_DEBUG_SOURCE_WINDOW_SYSTEM;
using glp::GL_DEBUG_SOURCE_SHADER_COMPILER;
using glp::GL_DEBUG_SOURCE_THIRD_PARTY;
using glp::GL_DEBUG_SOURCE_APPLICATION;
using glp::GL_DEBUG_SOURCE_OTHER;
using glp::GL_DEBUG_TYPE_ERROR;
using glp::GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR;
using glp::GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR;
using glp::GL_DEBUG_TYPE_PORTABILITY;
using glp::GL_DEBUG_TYPE_PERFORMANCE;
using glp::GL_DEBUG_TYPE_OTHER;
using glp::GL_LOSE_CONTEXT_ON_RESET;
using glp::GL_GUILTY_CONTEXT_RESET;
using glp::GL_INNOCENT_CONTEXT_RESET;
using glp::GL_UNKNOWN_CONTEXT_RESET;
using glp::GL_RESET_NOTIFICATION_STRATEGY;
using glp::GL_PROGRAM_SEPARABLE;
using glp::GL_ACTIVE_PROGRAM;
using glp::GL_PROGRAM_PIPELINE_BINDING;
using glp::GL_LAYER_PROVOKING_VERTEX;
using glp::GL_UNDEFINED_VERTEX;
using glp::GL_NO_RESET_NOTIFICATION;
...
using glp::GL_DEBUG_TYPE_MARKER;
using glp::GL_DEBUG_TYPE_PUSH_GROUP;
using glp::GL_DEBUG_TYPE_POP_GROUP;
using glp::GL_DEBUG_SEVERITY_NOTIFICATION;
using glp::GL_MAX_DEBUG_GROUP_STACK_DEPTH;
using glp::GL_DEBUG_GROUP_STACK_DEPTH;
...
using glp::GL_BUFFER;
using glp::GL_SHADER;
using glp::GL_PROGRAM;
using glp::GL_QUERY;
using glp::GL_PROGRAM_PIPELINE;
using glp::GL_MAX_VERTEX_ATTRIB_STRIDE;
using glp::GL_SAMPLER;
using glp::GL_MAX_LABEL_LENGTH;
...
using glp::GL_MAX_TESS_CONTROL_INPUT_COMPONENTS;
using glp::GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS;
using glp::GL_MAX_TEXTURE_IMAGE_UNITS;
using glp::GL_GEOMETRY_SHADER_INVOCATIONS;
...
using glp::GL_GEOMETRY_VERTICES_OUT;
using glp::GL_GEOMETRY_INPUT_TYPE;
using glp::GL_GEOMETRY_OUTPUT_TYPE;
...
using glp::GL_MAX_GEOMETRY_UNIFORM_BLOCKS;
...
using glp::GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS;
...
using glp::GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS;
using glp::GL_TEXTURE_BUFFER;
using glp::GL_TEXTURE_BUFFER_BINDING;
using glp::GL_MAX_TEXTURE_BUFFER_SIZE;
using glp::GL_TEXTURE_BINDING_BUFFER;
using glp::GL_TEXTURE_BUFFER_DATA_STORE_BINDING;
using glp::GL_ANY_SAMPLES_PASSED;
using glp::GL_SAMPLE_SHADING;
using glp::GL_MIN_SAMPLE_SHADING_VALUE;
...
using glp::GL_PRIMITIVES_GENERATED;
...
using glp::GL_FRAMEBUFFER_ATTACHMENT_LAYERED;
using glp::GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS;
using glp::GL_FLOAT_32_UNSIGNED_INT_24_8_REV;
using glp::GL_SAMPLER_2D_ARRAY;
using glp::GL_SAMPLER_BUFFER;
...
using glp::GL_INT_SAMPLER_BUFFER;
...
using glp::GL_UNSIGNED_INT_SAMPLER_BUFFER;
using glp::GL_GEOMETRY_SHADER;
using glp::GL_MAX_GEOMETRY_UNIFORM_COMPONENTS;
using glp::GL_MAX_GEOMETRY_OUTPUT_VERTICES;
using glp::GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS;
...
using glp::GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS;
using glp::GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS;
...
using glp::GL_FIRST_VERTEX_CONVENTION;
using glp::GL_LAST_VERTEX_CONVENTION;
using glp::GL_SAMPLE_POSITION;
using glp::GL_SAMPLE_MASK;
using glp::GL_SAMPLE_MASK_VALUE;
using glp::GL_MAX_SAMPLE_MASK_WORDS;
using glp::GL_MAX_GEOMETRY_SHADER_INVOCATIONS;
using glp::GL_MIN_FRAGMENT_INTERPOLATION_OFFSET;
using glp::GL_MAX_FRAGMENT_INTERPOLATION_OFFSET;
using glp::GL_FRAGMENT_INTERPOLATION_OFFSET_BITS;
using glp::GL_MIN_PROGRAM_TEXTURE_GATHER_OFFSET;
using glp::GL_MAX_PROGRAM_TEXTURE_GATHER_OFFSET;
using glp::GL_PATCH_VERTICES;
using glp::GL_TESS_CONTROL_OUTPUT_VERTICES;
using glp::GL_TESS_GEN_MODE;
using glp::GL_TESS_GEN_SPACING;
using glp::GL_TESS_GEN_VERTEX_ORDER;
using glp::GL_TESS_GEN_POINT_MODE;
using glp::GL_ISOLINES;
using glp::GL_FRACTIONAL_ODD;
using glp::GL_FRACTIONAL_EVEN;
using glp::GL_MAX_PATCH_VERTICES;
using glp::GL_MAX_TESS_GEN_LEVEL;
using glp::GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS;
using glp::GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS;
using glp::GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS;
using glp::GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS;
using glp::GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS;
using glp::GL_MAX_TESS_PATCH_COMPONENTS;
using glp::GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS;
using glp::GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS;
using glp::GL_TESS_EVALUATION_SHADER;
using glp::GL_TESS_CONTROL_SHADER;
using glp::GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS;
using glp::GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS;
...
using glp::GL_TEXTURE_CUBE_MAP_ARRAY;
using glp::GL_TEXTURE_BINDING_CUBE_MAP_ARRAY;
using glp::GL_SAMPLER_CUBE_MAP_ARRAY;
using glp::GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW;
using glp::GL_INT_SAMPLER_CUBE_MAP_ARRAY;
using glp::GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY;
using glp::GL_IMAGE_2D;
using glp::GL_IMAGE_3D;
using glp::GL_IMAGE_CUBE;
using glp::GL_IMAGE_BUFFER;
using glp::GL_IMAGE_2D_ARRAY;
using glp::GL_IMAGE_CUBE_MAP_ARRAY;
using glp::GL_INT_IMAGE_2D;
using glp::GL_INT_IMAGE_3D;
using glp::GL_INT_IMAGE_CUBE;
using glp::GL_INT_IMAGE_BUFFER;
using glp::GL_INT_IMAGE_2D_ARRAY;
using glp::GL_INT_IMAGE_CUBE_MAP_ARRAY;
using glp::GL_UNSIGNED_INT_IMAGE_2D;
using glp::GL_UNSIGNED_INT_IMAGE_3D;
using glp::GL_UNSIGNED_INT_IMAGE_CUBE;
using glp::GL_UNSIGNED_INT_IMAGE_BUFFER;
using glp::GL_UNSIGNED_INT_IMAGE_2D_ARRAY;
using glp::GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY;
...
using glp::GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS;
using glp::GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS;
using glp::GL_MAX_GEOMETRY_IMAGE_UNIFORMS;
...
using glp::GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS;
using glp::GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS;
using glp::GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS;
...
using glp::GL_TEXTURE_2D_MULTISAMPLE_ARRAY;
using glp::GL_TEXTURE_BINDING_2D_MULTISAMPLE;
using glp::GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY;
...
using glp::GL_SAMPLER_2D_MULTISAMPLE_ARRAY;
using glp::GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY;
using glp::GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY;
...
using glp::GL_MAX_GEOMETRY_INPUT_COMPONENTS;
using glp::GL_MAX_GEOMETRY_OUTPUT_COMPONENTS;
using glp::GL_MAX_FRAGMENT_INPUT_COMPONENTS;
using glp::GL_TEXTURE_IMMUTABLE_FORMAT;
using glp::GL_MAX_DEBUG_MESSAGE_LENGTH;
using glp::GL_MAX_DEBUG_LOGGED_MESSAGES;
using glp::GL_DEBUG_LOGGED_MESSAGES;
using glp::GL_DEBUG_SEVERITY_HIGH;
using glp::GL_DEBUG_SEVERITY_MEDIUM;
using glp::GL_DEBUG_SEVERITY_LOW;
using glp::GL_TEXTURE_BUFFER_OFFSET;
using glp::GL_TEXTURE_BUFFER_SIZE;
using glp::GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT;
...
using glp::GL_MULTIPLY;
using glp::GL_SCREEN;
using glp::GL_OVERLAY;
using glp::GL_DARKEN;
using glp::GL_LIGHTEN;
using glp::GL_COLORDODGE;
using glp::GL_COLORBURN;
using glp::GL_HARDLIGHT;
using glp::GL_SOFTLIGHT;
using glp::GL_DIFFERENCE;
using glp::GL_EXCLUSION;
using glp::GL_HSL_HUE;
using glp::GL_HSL_SATURATION;
using glp::GL_HSL_COLOR;
using glp::GL_HSL_LUMINOSITY;
using glp::GL_PRIMITIVE_BOUNDING_BOX;
...
using glp::GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS;
using glp::GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS;
using glp::GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS;
...
using glp::GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS;
using glp::GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS;
using glp::GL_MAX_GEOMETRY_ATOMIC_COUNTERS;
...
using glp::GL_REFERENCED_BY_TESS_CONTROL_SHADER;
using glp::GL_REFERENCED_BY_TESS_EVALUATION_SHADER;
using glp::GL_REFERENCED_BY_GEOMETRY_SHADER;
...
using glp::GL_FRAMEBUFFER_DEFAULT_LAYERS;
...
using glp::GL_MAX_FRAMEBUFFER_LAYERS;
using glp::GL_MAX_FRAMEBUFFER_SAMPLES;
using glp::GL_NUM_SAMPLE_COUNTS;
using glp::GL_MULTISAMPLE_LINE_WIDTH_RANGE;
using glp::GL_MULTISAMPLE_LINE_WIDTH_GRANULARITY;
using glp::GL_COMPRESSED_RGBA_ASTC_4x4;
using glp::GL_COMPRESSED_RGBA_ASTC_5x4;
using glp::GL_COMPRESSED_RGBA_ASTC_5x5;
using glp::GL_COMPRESSED_RGBA_ASTC_6x5;
using glp::GL_COMPRESSED_RGBA_ASTC_6x6;
using glp::GL_COMPRESSED_RGBA_ASTC_8x5;
using glp::GL_COMPRESSED_RGBA_ASTC_8x6;
using glp::GL_COMPRESSED_RGBA_ASTC_8x8;
using glp::GL_COMPRESSED_RGBA_ASTC_10x5;
using glp::GL_COMPRESSED_RGBA_ASTC_10x6;
using glp::GL_COMPRESSED_RGBA_ASTC_10x8;
using glp::GL_COMPRESSED_RGBA_ASTC_10x10;
using glp::GL_COMPRESSED_RGBA_ASTC_12x10;
using glp::GL_COMPRESSED_RGBA_ASTC_12x12;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10;
using glp::GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12;
