...
{
    return static_cast<gl32::GLenum>(glbinding::currentBinding().glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl32::GLenum>(glbinding::currentBinding().glClientWaitSync(sync, flags, timeout));
}
...
GLenum glGetError()
{
    return static_cast<gl32::GLenum>(glbinding::currentBinding().glGetError());
}
