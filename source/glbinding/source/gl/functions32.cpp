...
{
    return static_cast<gl32::GLenum>(gl::glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl32::GLenum>(gl::glClientWaitSync(sync, flags, timeout));
}
...
GLenum glGetError()
{
    return static_cast<gl32::GLenum>(gl::glGetError());
}
