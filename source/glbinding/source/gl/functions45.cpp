...
{
    return static_cast<gl45::GLenum>(gl::glCheckFramebufferStatus(target));
}

GLenum glCheckNamedFramebufferStatus(GLuint framebuffer, GLenum target)
{
    return static_cast<gl45::GLenum>(gl::glCheckNamedFramebufferStatus(framebuffer, target));
}
...
{
    return static_cast<gl45::GLenum>(gl::glClientWaitSync(sync, flags, timeout));
}
...
GLenum glGetError()
{
    return static_cast<gl45::GLenum>(gl::glGetError());
}
...
{
    return static_cast<gl45::GLenum>(gl::glGetGraphicsResetStatus());
}
