...
{
    return static_cast<gl32core::GLenum>(gl::glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl32core::GLenum>(gl::glClientWaitSync(sync, flags, timeout));
}
...
GLenum glGetError()
{
    return static_cast<gl32core::GLenum>(gl::glGetError());
}
