...
{
    return static_cast<gl41::GLenum>(gl::glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl41::GLenum>(gl::glClientWaitSync(sync, flags, timeout));
}
...
GLenum glGetError()
{
    return static_cast<gl41::GLenum>(gl::glGetError());
}
