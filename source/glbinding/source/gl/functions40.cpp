...
{
    return static_cast<gl40::GLenum>(gl::glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl40::GLenum>(gl::glClientWaitSync(sync, flags, timeout));
}
...
GLenum glGetError()
{
    return static_cast<gl40::GLenum>(gl::glGetError());
}
