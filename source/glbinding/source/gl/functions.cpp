...
{
    return (*glbinding::currentBinding().glCheckFramebufferStatus)(target);
}

GLenum glCheckFramebufferStatusEXT(GLenum target)
{
    return (*glbinding::currentBinding().glCheckFramebufferStatusEXT)(target);
}

GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return (*glbinding::currentBinding().glCheckNamedFramebufferStatusEXT)(framebuffer, target);
}
...
{
    return (*glbinding::currentBinding().glClientWaitSync)(sync, flags, timeout);
}
...
GLenum glGetError()
{
    return (*glbinding::currentBinding().glGetError)();
}
...
{
    return (*glbinding::currentBinding().glGetGraphicsResetStatusARB)();
}
...
{
    return (*glbinding::currentBinding().glObjectPurgeableAPPLE)(objectType, name, option);
}

GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return (*glbinding::currentBinding().glObjectUnpurgeableAPPLE)(objectType, name, option);
}
...
{
    return (*glbinding::currentBinding().glPathGlyphIndexArrayNV)(firstPathName, fontTarget, fontName, fontStyle, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale);
}
...
{
    return (*glbinding::currentBinding().glPathGlyphIndexRangeNV)(fontTarget, fontName, fontStyle, pathParameterTemplate, emScale, baseAndCount);
}
...
{
    return (*glbinding::currentBinding().glPathMemoryGlyphIndexArrayNV)(firstPathName, fontTarget, fontSize, fontData, faceIndex, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale);
}
...
{
    return (*glbinding::currentBinding().glQueryMatrixxOES)(mantissa, exponent);
}
...
{
    return (*glbinding::currentBinding().glVideoCaptureNV)(video_capture_slot, sequence_num, capture_time);
}
