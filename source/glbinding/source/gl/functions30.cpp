...
{
    return static_cast<gl30::GLenum>(glbinding::currentBinding().glCheckFramebufferStatus(target));
}
...
GLenum glGetError()
{
    return static_cast<gl30::GLenum>(glbinding::currentBinding().glGetError());
}
