...
{
    return static_cast<gl15ext::GLenum>(gl::glCheckFramebufferStatus(target));
}

GLenum glCheckFramebufferStatusEXT(GLenum target)
{
    return static_cast<gl15ext::GLenum>(gl::glCheckFramebufferStatusEXT(target));
}

GLenum glCheckNamedFramebufferStatus(GLuint framebuffer, GLenum target)
{
    return static_cast<gl15ext::GLenum>(gl::glCheckNamedFramebufferStatus(framebuffer, target));
}

GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return static_cast<gl15ext::GLenum>(gl::glCheckNamedFramebufferStatusEXT(framebuffer, target));
}
...
{
    return static_cast<gl15ext::GLenum>(gl::glClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl15ext::GLenum>(gl::glGetGraphicsResetStatus());
}

GLenum glGetGraphicsResetStatusARB()
{
    return static_cast<gl15ext::GLenum>(gl::glGetGraphicsResetStatusARB());
}
...
{
    return static_cast<gl15ext::GLenum>(gl::glObjectPurgeableAPPLE(objectType, name, option));
}

GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return static_cast<gl15ext::GLenum>(gl::glObjectUnpurgeableAPPLE(objectType, name, option));
}
...
{
    return static_cast<gl15ext::GLenum>(gl::glPathGlyphIndexArrayNV(firstPathName, fontTarget, fontName, fontStyle, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale));
}
...
{
    return static_cast<gl15ext::GLenum>(gl::glPathGlyphIndexRangeNV(fontTarget, fontName, fontStyle, pathParameterTemplate, emScale, baseAndCount));
}
...
{
    return static_cast<gl15ext::GLenum>(gl::glPathMemoryGlyphIndexArrayNV(firstPathName, fontTarget, fontSize, fontData, faceIndex, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale));
}
...
{
    return static_cast<gl15ext::GLbitfield>(gl::glQueryMatrixxOES(mantissa, exponent));
}
...
{
    return static_cast<gl15ext::GLenum>(gl::glVideoCaptureNV(video_capture_slot, sequence_num, capture_time));
}
