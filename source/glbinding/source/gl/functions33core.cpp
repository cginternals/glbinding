...
{
    return static_cast<gl33core::GLenum>(gl::glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl33core::GLenum>(gl::glClientWaitSync(sync, flags, timeout));
}
...
GLenum glGetError()
{
    return static_cast<gl33core::GLenum>(gl::glGetError());
}
