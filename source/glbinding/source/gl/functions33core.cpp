...
{
    return static_cast<gl33core::GLenum>((*glbinding::currentBinding().glCheckFramebufferStatus)(target));
}
...
{
    return static_cast<gl33core::GLenum>((*glbinding::currentBinding().glClientWaitSync)(sync, flags, timeout));
}
...
GLenum glGetError()
{
    return static_cast<gl33core::GLenum>((*glbinding::currentBinding().glGetError)());
}
