...
{
    return static_cast<gl44::GLenum>(gl::glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl44::GLenum>(gl::glClientWaitSync(sync, flags, timeout));
}
...
GLenum glGetError()
{
    return static_cast<gl44::GLenum>(gl::glGetError());
}
