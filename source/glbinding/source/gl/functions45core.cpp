...
{
    return static_cast<gl45core::GLenum>(gl::glCheckFramebufferStatus(target));
}

GLenum glCheckNamedFramebufferStatus(GLuint framebuffer, GLenum target)
{
    return static_cast<gl45core::GLenum>(gl::glCheckNamedFramebufferStatus(framebuffer, target));
}
...
{
    return static_cast<gl45core::GLenum>(gl::glClientWaitSync(sync, flags, timeout));
}
...
GLenum glGetError()
{
    return static_cast<gl45core::GLenum>(gl::glGetError());
}
...
{
    return static_cast<gl45core::GLenum>(gl::glGetGraphicsResetStatus());
}
