...
{
    return static_cast<gl41core::GLenum>(gl::glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl41core::GLenum>(gl::glClientWaitSync(sync, flags, timeout));
}
...
GLenum glGetError()
{
    return static_cast<gl41core::GLenum>(gl::glGetError());
}
