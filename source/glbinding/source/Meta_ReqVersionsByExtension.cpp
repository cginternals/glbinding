...
const std::unordered_map<GLextension, Version> Meta_ReqVersionsByExtension = 
{
    ...
    { GLextension::GL_ARB_depth_texture, { 1, 4 } },
    { GLextension::GL_ARB_draw_buffers, { 2, 0 } },
    ...
    { GLextension::GL_ARB_fragment_shader, { 2, 0 } },
    { GLextension::GL_ARB_framebuffer_no_attachments, { 4, 3 } },
    { GLextension::GL_ARB_framebuffer_object, { 4, 4 } },
    ...
    { GLextension::GL_ARB_map_buffer_range, { 4, 4 } },
    { GLextension::GL_ARB_multi_bind, { 4, 4 } },
    { GLextension::GL_ARB_multi_draw_indirect, { 4, 3 } },
    { GLextension::GL_ARB_multisample, { 1, 3 } },
    { GLextension::GL_ARB_multitexture, { 1, 3 } },
    { GLextension::GL_ARB_occlusion_query, { 1, 5 } },
    { GLextension::GL_ARB_occlusion_query2, { 3, 3 } },
    { GLextension::GL_ARB_pixel_buffer_object, { 2, 1 } },
    { GLextension::GL_ARB_point_parameters, { 1, 4 } },
    { GLextension::GL_ARB_point_sprite, { 2, 0 } },
    ...
    { GLextension::GL_ARB_seamless_cubemap_per_texture, { 3, 2 } },
    ...
    { GLextension::GL_ARB_shading_language_100, { 2, 0 } },
    { GLextension::GL_ARB_shadow, { 1, 4 } },
    { GLextension::GL_ARB_stencil_texturing, { 4, 3 } },
    { GLextension::GL_ARB_sync, { 3, 2 } },
    { GLextension::GL_ARB_tessellation_shader, { 4, 0 } },
    { GLextension::GL_ARB_texture_border_clamp, { 1, 3 } },
    { GLextension::GL_ARB_texture_buffer_object_rgb32, { 3, 0 } },
    { GLextension::GL_ARB_texture_buffer_range, { 4, 3 } },
    { GLextension::GL_ARB_texture_compression, { 1, 3 } },
    { GLextension::GL_ARB_texture_compression_bptc, { 4, 2 } },
    { GLextension::GL_ARB_texture_compression_rgtc, { 3, 0 } },
    { GLextension::GL_ARB_texture_cube_map, { 1, 3 } },
    { GLextension::GL_ARB_texture_cube_map_array, { 4, 0 } },
    { GLextension::GL_ARB_texture_env_combine, { 1, 3 } },
    { GLextension::GL_ARB_texture_env_dot3, { 1, 3 } },
    { GLextension::GL_ARB_texture_mirror_clamp_to_edge, { 4, 4 } },
    { GLextension::GL_ARB_texture_mirrored_repeat, { 1, 4 } },
    ...
    { GLextension::GL_ARB_transpose_matrix, { 1, 3 } },
    { GLextension::GL_ARB_uniform_buffer_object, { 3, 1 } },
    { GLextension::GL_ARB_vertex_array_bgra, { 1, 2 } },
    ...
    { GLextension::GL_ARB_vertex_buffer_object, { 1, 5 } },
    ...
    { GLextension::GL_ARB_window_pos, { 1, 4 } },
    { GLextension::GL_EXT_vertex_array_bgra, { 1, 2 } },
    { GLextension::GL_NV_vertex_program3, { 2, 0 } },
    { GLextension::GL_OES_depth_texture, { 1, 1 } },
    { GLextension::GL_OES_element_index_uint, { 1, 1 } },
    { GLextension::GL_OES_texture_float, { 1, 1 } }
};
