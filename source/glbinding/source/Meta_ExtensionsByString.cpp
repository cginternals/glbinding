...
const std::unordered_map<std::string, GLextension> Meta_ExtensionsByString
{
    ...
    { "GL_APPLE_texture_2D_limited_npot", GLextension::GL_APPLE_texture_2D_limited_npot },
    ...
    { "GL_IMG_texture_env_enhanced_fixed_function", GLextension::GL_IMG_texture_env_enhanced_fixed_function },
    { "GL_IMG_user_clip_plane", GLextension::GL_IMG_user_clip_plane },
    ...
    { "GL_OES_blend_equation_separate", GLextension::GL_OES_blend_equation_separate },
    { "GL_OES_blend_func_separate", GLextension::GL_OES_blend_func_separate },
    { "GL_OES_blend_subtract", GLextension::GL_OES_blend_subtract },
    ...
    { "GL_OES_draw_texture", GLextension::GL_OES_draw_texture },
    { "GL_OES_element_index_uint", GLextension::GL_OES_element_index_uint },
    { "GL_OES_extended_matrix_palette", GLextension::GL_OES_extended_matrix_palette },
    ...
    { "GL_OES_framebuffer_object", GLextension::GL_OES_framebuffer_object },
    { "GL_OES_get_program_binary", GLextension::GL_OES_get_program_binary },
    { "GL_OES_mapbuffer", GLextension::GL_OES_mapbuffer },
    { "GL_OES_matrix_get", GLextension::GL_OES_matrix_get },
    { "GL_OES_matrix_palette", GLextension::GL_OES_matrix_palette },
    { "GL_OES_packed_depth_stencil", GLextension::GL_OES_packed_depth_stencil },
    { "GL_OES_point_size_array", GLextension::GL_OES_point_size_array },
    { "GL_OES_point_sprite", GLextension::GL_OES_point_sprite },
    ...
    { "GL_OES_stencil8", GLextension::GL_OES_stencil8 },
    { "GL_OES_stencil_wrap", GLextension::GL_OES_stencil_wrap },
    ...
    { "GL_OES_texture_cube_map", GLextension::GL_OES_texture_cube_map },
    { "GL_OES_texture_env_crossbar", GLextension::GL_OES_texture_env_crossbar },
    ...
    { "GL_OES_texture_mirrored_repeat", GLextension::GL_OES_texture_mirrored_repeat },
