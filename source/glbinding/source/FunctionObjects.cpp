...
Function<void, GLuint, GLuint> FunctionObjects::ActiveShaderProgramEXT("glActiveShaderProgramEXT");
...
Function<void, GLenum, GLclampf> FunctionObjects::AlphaFuncQCOM("glAlphaFuncQCOM");
Function<void, GLenum, GLfixed> FunctionObjects::AlphaFuncx("glAlphaFuncx");
...
Function<void, GLenum, GLuint> FunctionObjects::BeginQueryEXT("glBeginQueryEXT");
...
Function<void, GLenum, GLuint> FunctionObjects::BindFramebufferOES("glBindFramebufferOES");
...
Function<void, GLuint> FunctionObjects::BindProgramPipelineEXT("glBindProgramPipelineEXT");
...
Function<void, GLenum, GLuint> FunctionObjects::BindRenderbufferOES("glBindRenderbufferOES");
...
Function<void, GLuint> FunctionObjects::BindVertexArrayOES("glBindVertexArrayOES");
...
Function<void> FunctionObjects::BlendBarrierKHR("glBlendBarrierKHR");
...
Function<void, GLenum> FunctionObjects::BlendEquationOES("glBlendEquationOES");
...
Function<void, GLenum, GLenum> FunctionObjects::BlendEquationSeparateOES("glBlendEquationSeparateOES");
...
Function<void, GLuint, GLenum, GLenum> FunctionObjects::BlendEquationSeparateiEXT("glBlendEquationSeparateiEXT");
...
Function<void, GLuint, GLenum> FunctionObjects::BlendEquationiEXT("glBlendEquationiEXT");
...
Function<void, GLenum, GLenum, GLenum, GLenum> FunctionObjects::BlendFuncSeparateOES("glBlendFuncSeparateOES");
...
Function<void, GLuint, GLenum, GLenum, GLenum, GLenum> FunctionObjects::BlendFuncSeparateiEXT("glBlendFuncSeparateiEXT");
...
Function<void, GLuint, GLenum, GLenum> FunctionObjects::BlendFunciEXT("glBlendFunciEXT");
...
Function<void, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum> FunctionObjects::BlitFramebufferANGLE("glBlitFramebufferANGLE");
...
Function<void, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum> FunctionObjects::BlitFramebufferNV("glBlitFramebufferNV");
...
Function<GLenum, GLenum> FunctionObjects::CheckFramebufferStatusOES("glCheckFramebufferStatusOES");
...
Function<void, GLfixed, GLfixed, GLfixed, GLfixed> FunctionObjects::ClearColorx("glClearColorx");
...
Function<void, GLfixed> FunctionObjects::ClearDepthx("glClearDepthx");
...
Function<GLenum, GLsync, GLbitfield, GLuint64> FunctionObjects::ClientWaitSyncAPPLE("glClientWaitSyncAPPLE");
Function<void, GLenum, const GLdouble *> FunctionObjects::ClipPlane("glClipPlane");
Function<void, GLenum, const GLfloat *> FunctionObjects::ClipPlanef("glClipPlanef");
Function<void, GLenum, const GLfloat *> FunctionObjects::ClipPlanefIMG("glClipPlanefIMG");
Function<void, GLenum, const GLfloat *> FunctionObjects::ClipPlanefOES("glClipPlanefOES");
Function<void, GLenum, const GLfixed *> FunctionObjects::ClipPlanex("glClipPlanex");
Function<void, GLenum, const GLfixed *> FunctionObjects::ClipPlanexIMG("glClipPlanexIMG");
...
Function<void, GLfixed, GLfixed, GLfixed, GLfixed> FunctionObjects::Color4x("glColor4x");
...
Function<void, GLuint, GLboolean, GLboolean, GLboolean, GLboolean> FunctionObjects::ColorMaskiEXT("glColorMaskiEXT");
...
Function<void, GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const void *> FunctionObjects::CompressedTexImage3DOES("glCompressedTexImage3DOES");
...
Function<void, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const void *> FunctionObjects::CompressedTexSubImage3DOES("glCompressedTexSubImage3DOES");
...
Function<void, GLenum, GLenum, GLintptr, GLintptr, GLsizeiptr> FunctionObjects::CopyBufferSubDataNV("glCopyBufferSubDataNV");
...
Function<void, GLuint, GLenum, GLint, GLint, GLint, GLint, GLuint, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei> FunctionObjects::CopyImageSubDataEXT("glCopyImageSubDataEXT");
...
Function<void, GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei> FunctionObjects::CopyTexSubImage3DOES("glCopyTexSubImage3DOES");
...
Function<void, GLuint, GLuint, GLint, GLsizei> FunctionObjects::CopyTextureLevelsAPPLE("glCopyTextureLevelsAPPLE");
...
Function<void, GLboolean> FunctionObjects::CoverageMaskNV("glCoverageMaskNV");
Function<void, GLenum> FunctionObjects::CoverageOperationNV("glCoverageOperationNV");
...
Function<GLuint, GLenum, GLsizei, const GLchar **> FunctionObjects::CreateShaderProgramvEXT("glCreateShaderProgramvEXT");
...
Function<void, GLuint> FunctionObjects::CurrentPaletteMatrixOES("glCurrentPaletteMatrixOES");
...
Function<void, GLDEBUGPROCKHR, const void *> FunctionObjects::DebugMessageCallbackKHR("glDebugMessageCallbackKHR");
...
Function<void, GLenum, GLenum, GLenum, GLsizei, const GLuint *, GLboolean> FunctionObjects::DebugMessageControlKHR("glDebugMessageControlKHR");
...
Function<void, GLenum, GLenum, GLuint, GLenum, GLsizei, const GLchar *> FunctionObjects::DebugMessageInsertKHR("glDebugMessageInsertKHR");
...
Function<void, GLsizei, const GLuint *> FunctionObjects::DeleteFramebuffersOES("glDeleteFramebuffersOES");
...
Function<void, GLsizei, const GLuint *> FunctionObjects::DeleteProgramPipelinesEXT("glDeleteProgramPipelinesEXT");
...
Function<void, GLsizei, const GLuint *> FunctionObjects::DeleteQueriesEXT("glDeleteQueriesEXT");
...
Function<void, GLsizei, const GLuint *> FunctionObjects::DeleteRenderbuffersOES("glDeleteRenderbuffersOES");
...
Function<void, GLsync> FunctionObjects::DeleteSyncAPPLE("glDeleteSyncAPPLE");
...
Function<void, GLsizei, const GLuint *> FunctionObjects::DeleteVertexArraysOES("glDeleteVertexArraysOES");
...
Function<void, GLfixed, GLfixed> FunctionObjects::DepthRangex("glDepthRangex");
...
Function<void, GLuint> FunctionObjects::DisableDriverControlQCOM("glDisableDriverControlQCOM");
...
Function<void, GLenum, GLuint> FunctionObjects::DisableiEXT("glDisableiEXT");
Function<void, GLenum, GLsizei, const GLenum *> FunctionObjects::DiscardFramebufferEXT("glDiscardFramebufferEXT");
...
Function<void, GLenum, GLint, GLsizei, GLsizei> FunctionObjects::DrawArraysInstancedANGLE("glDrawArraysInstancedANGLE");
...
Function<void, GLenum, GLint, GLsizei, GLsizei> FunctionObjects::DrawArraysInstancedNV("glDrawArraysInstancedNV");
...
Function<void, GLsizei, const GLenum *> FunctionObjects::DrawBuffersEXT("glDrawBuffersEXT");
Function<void, GLint, const GLenum *, const GLint *> FunctionObjects::DrawBuffersIndexedEXT("glDrawBuffersIndexedEXT");
Function<void, GLsizei, const GLenum *> FunctionObjects::DrawBuffersNV("glDrawBuffersNV");
...
Function<void, GLenum, GLsizei, GLenum, const void *, GLsizei> FunctionObjects::DrawElementsInstancedANGLE("glDrawElementsInstancedANGLE");
...
Function<void, GLenum, GLsizei, GLenum, const void *, GLsizei> FunctionObjects::DrawElementsInstancedNV("glDrawElementsInstancedNV");
...
Function<void, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat> FunctionObjects::DrawTexfOES("glDrawTexfOES");
Function<void, const GLfloat *> FunctionObjects::DrawTexfvOES("glDrawTexfvOES");
Function<void, GLint, GLint, GLint, GLint, GLint> FunctionObjects::DrawTexiOES("glDrawTexiOES");
Function<void, const GLint *> FunctionObjects::DrawTexivOES("glDrawTexivOES");
Function<void, GLshort, GLshort, GLshort, GLshort, GLshort> FunctionObjects::DrawTexsOES("glDrawTexsOES");
Function<void, const GLshort *> FunctionObjects::DrawTexsvOES("glDrawTexsvOES");
...
Function<void, GLfixed, GLfixed, GLfixed, GLfixed, GLfixed> FunctionObjects::DrawTexxOES("glDrawTexxOES");
Function<void, const GLfixed *> FunctionObjects::DrawTexxvOES("glDrawTexxvOES");
...
Function<void, GLenum, GLeglImageOES> FunctionObjects::EGLImageTargetRenderbufferStorageOES("glEGLImageTargetRenderbufferStorageOES");
Function<void, GLenum, GLeglImageOES> FunctionObjects::EGLImageTargetTexture2DOES("glEGLImageTargetTexture2DOES");
...
Function<void, GLuint> FunctionObjects::EnableDriverControlQCOM("glEnableDriverControlQCOM");
...
Function<void, GLenum, GLuint> FunctionObjects::EnableiEXT("glEnableiEXT");
...
Function<void, GLenum> FunctionObjects::EndQueryEXT("glEndQueryEXT");
Function<void, GLenum, GLuint> FunctionObjects::EndQueryIndexed("glEndQueryIndexed");
Function<void, GLbitfield> FunctionObjects::EndTilingQCOM("glEndTilingQCOM");
...
Function<void, GLenum, void **> FunctionObjects::ExtGetBufferPointervQCOM("glExtGetBufferPointervQCOM");
Function<void, GLuint *, GLint, GLint *> FunctionObjects::ExtGetBuffersQCOM("glExtGetBuffersQCOM");
Function<void, GLuint *, GLint, GLint *> FunctionObjects::ExtGetFramebuffersQCOM("glExtGetFramebuffersQCOM");
Function<void, GLuint, GLenum, GLchar *, GLint *> FunctionObjects::ExtGetProgramBinarySourceQCOM("glExtGetProgramBinarySourceQCOM");
Function<void, GLuint *, GLint, GLint *> FunctionObjects::ExtGetProgramsQCOM("glExtGetProgramsQCOM");
Function<void, GLuint *, GLint, GLint *> FunctionObjects::ExtGetRenderbuffersQCOM("glExtGetRenderbuffersQCOM");
Function<void, GLuint *, GLint, GLint *> FunctionObjects::ExtGetShadersQCOM("glExtGetShadersQCOM");
Function<void, GLuint, GLenum, GLint, GLenum, GLint *> FunctionObjects::ExtGetTexLevelParameterivQCOM("glExtGetTexLevelParameterivQCOM");
Function<void, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, void *> FunctionObjects::ExtGetTexSubImageQCOM("glExtGetTexSubImageQCOM");
Function<void, GLuint *, GLint, GLint *> FunctionObjects::ExtGetTexturesQCOM("glExtGetTexturesQCOM");
Function<GLboolean, GLuint> FunctionObjects::ExtIsProgramBinaryQCOM("glExtIsProgramBinaryQCOM");
Function<void, GLenum, GLenum, GLint> FunctionObjects::ExtTexObjectStateOverrideiQCOM("glExtTexObjectStateOverrideiQCOM");
...
Function<GLsync, GLenum, GLbitfield> FunctionObjects::FenceSyncAPPLE("glFenceSyncAPPLE");
...
Function<void, GLenum, GLintptr, GLsizeiptr> FunctionObjects::FlushMappedBufferRangeEXT("glFlushMappedBufferRangeEXT");
...
Function<void, GLenum, GLfixed> FunctionObjects::Fogx("glFogx");
Function<void, GLenum, GLfixed> FunctionObjects::FogxOES("glFogxOES");
Function<void, GLenum, const GLfixed *> FunctionObjects::Fogxv("glFogxv");
...
Function<void, GLenum, GLenum, GLenum, GLuint> FunctionObjects::FramebufferRenderbufferOES("glFramebufferRenderbufferOES");
...
Function<void, GLenum, GLenum, GLenum, GLuint, GLint, GLsizei> FunctionObjects::FramebufferTexture2DMultisampleEXT("glFramebufferTexture2DMultisampleEXT");
Function<void, GLenum, GLenum, GLenum, GLuint, GLint, GLsizei> FunctionObjects::FramebufferTexture2DMultisampleIMG("glFramebufferTexture2DMultisampleIMG");
Function<void, GLenum, GLenum, GLenum, GLuint, GLint> FunctionObjects::FramebufferTexture2DOES("glFramebufferTexture2DOES");
...
Function<void, GLenum, GLenum, GLenum, GLuint, GLint, GLint> FunctionObjects::FramebufferTexture3DOES("glFramebufferTexture3DOES");
...
Function<void, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat> FunctionObjects::Frustumf("glFrustumf");
Function<void, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat> FunctionObjects::FrustumfOES("glFrustumfOES");
Function<void, GLfixed, GLfixed, GLfixed, GLfixed, GLfixed, GLfixed> FunctionObjects::Frustumx("glFrustumx");
...
Function<void, GLsizei, GLuint *> FunctionObjects::GenFramebuffersOES("glGenFramebuffersOES");
...
Function<void, GLsizei, GLuint *> FunctionObjects::GenProgramPipelinesEXT("glGenProgramPipelinesEXT");
...
Function<void, GLsizei, GLuint *> FunctionObjects::GenQueriesEXT("glGenQueriesEXT");
...
Function<void, GLsizei, GLuint *> FunctionObjects::GenRenderbuffersOES("glGenRenderbuffersOES");
...
Function<void, GLsizei, GLuint *> FunctionObjects::GenVertexArraysOES("glGenVertexArraysOES");
...
Function<void, GLenum> FunctionObjects::GenerateMipmapOES("glGenerateMipmapOES");
...
Function<void, GLenum, GLenum, void **> FunctionObjects::GetBufferPointervOES("glGetBufferPointervOES");
...
Function<void, GLenum, GLfloat *> FunctionObjects::GetClipPlanef("glGetClipPlanef");
Function<void, GLenum, GLfloat *> FunctionObjects::GetClipPlanefOES("glGetClipPlanefOES");
Function<void, GLenum, GLfixed *> FunctionObjects::GetClipPlanex("glGetClipPlanex");
...
Function<GLuint, GLuint, GLsizei, GLenum *, GLenum *, GLuint *, GLenum *, GLsizei *, GLchar *> FunctionObjects::GetDebugMessageLogKHR("glGetDebugMessageLogKHR");
...
Function<void, GLuint, GLsizei, GLsizei *, GLchar *> FunctionObjects::GetDriverControlStringQCOM("glGetDriverControlStringQCOM");
Function<void, GLint *, GLsizei, GLuint *> FunctionObjects::GetDriverControlsQCOM("glGetDriverControlsQCOM");
...
Function<void, GLenum, GLfixed *> FunctionObjects::GetFixedv("glGetFixedv");
...
Function<void, GLenum, GLenum, GLenum, GLint *> FunctionObjects::GetFramebufferAttachmentParameterivOES("glGetFramebufferAttachmentParameterivOES");
...
Function<GLenum> FunctionObjects::GetGraphicsResetStatusEXT("glGetGraphicsResetStatusEXT");
...
Function<void, GLenum, GLint64 *> FunctionObjects::GetInteger64vAPPLE("glGetInteger64vAPPLE");
...
Function<void, GLenum, GLuint, GLint *> FunctionObjects::GetIntegeri_vEXT("glGetIntegeri_vEXT");
...
Function<void, GLenum, GLenum, GLfixed *> FunctionObjects::GetLightxv("glGetLightxv");
Function<void, GLenum, GLenum, GLfixed *> FunctionObjects::GetLightxvOES("glGetLightxvOES");
...
Function<void, GLenum, GLenum, GLfixed *> FunctionObjects::GetMaterialxv("glGetMaterialxv");
Function<void, GLenum, GLenum, GLfixed *> FunctionObjects::GetMaterialxvOES("glGetMaterialxvOES");
...
Function<void, GLenum, GLuint, GLsizei, GLsizei *, GLchar *> FunctionObjects::GetObjectLabelKHR("glGetObjectLabelKHR");
...
Function<void, const void *, GLsizei, GLsizei *, GLchar *> FunctionObjects::GetObjectPtrLabelKHR("glGetObjectPtrLabelKHR");
...
Function<void, GLenum, void **> FunctionObjects::GetPointervKHR("glGetPointervKHR");
...
Function<void, GLuint, GLsizei, GLsizei *, GLenum *, void *> FunctionObjects::GetProgramBinaryOES("glGetProgramBinaryOES");
...
Function<void, GLuint, GLsizei, GLsizei *, GLchar *> FunctionObjects::GetProgramPipelineInfoLogEXT("glGetProgramPipelineInfoLogEXT");
Function<void, GLuint, GLenum, GLint *> FunctionObjects::GetProgramPipelineiv("glGetProgramPipelineiv");
Function<void, GLuint, GLenum, GLint *> FunctionObjects::GetProgramPipelineivEXT("glGetProgramPipelineivEXT");
...
Function<void, GLuint, GLenum, GLint *> FunctionObjects::GetQueryObjectivEXT("glGetQueryObjectivEXT");
...
Function<void, GLuint, GLenum, GLuint *> FunctionObjects::GetQueryObjectuivEXT("glGetQueryObjectuivEXT");
...
Function<void, GLenum, GLenum, GLint *> FunctionObjects::GetQueryivEXT("glGetQueryivEXT");
...
Function<void, GLenum, GLenum, GLint *> FunctionObjects::GetRenderbufferParameterivOES("glGetRenderbufferParameterivOES");
Function<void, GLuint, GLenum, GLint *> FunctionObjects::GetSamplerParameterIiv("glGetSamplerParameterIiv");
Function<void, GLuint, GLenum, GLint *> FunctionObjects::GetSamplerParameterIivEXT("glGetSamplerParameterIivEXT");
Function<void, GLuint, GLenum, GLuint *> FunctionObjects::GetSamplerParameterIuiv("glGetSamplerParameterIuiv");
Function<void, GLuint, GLenum, GLuint *> FunctionObjects::GetSamplerParameterIuivEXT("glGetSamplerParameterIuivEXT");
...
Function<void, GLsync, GLenum, GLsizei, GLsizei *, GLint *> FunctionObjects::GetSyncivAPPLE("glGetSyncivAPPLE");
...
Function<void, GLenum, GLenum, GLfixed *> FunctionObjects::GetTexEnvxv("glGetTexEnvxv");
...
Function<void, GLenum, GLenum, GLfloat *> FunctionObjects::GetTexGenfvOES("glGetTexGenfvOES");
Function<void, GLenum, GLenum, GLint *> FunctionObjects::GetTexGeniv("glGetTexGeniv");
Function<void, GLenum, GLenum, GLint *> FunctionObjects::GetTexGenivOES("glGetTexGenivOES");
...
Function<void, GLenum, GLenum, GLfixed *> FunctionObjects::GetTexParameterxv("glGetTexParameterxv");
...
Function<void, GLuint, GLsizei, GLsizei *, GLchar *> FunctionObjects::GetTranslatedShaderSourceANGLE("glGetTranslatedShaderSourceANGLE");
...
Function<void, GLuint, GLint, GLsizei, GLfloat *> FunctionObjects::GetnUniformfvEXT("glGetnUniformfvEXT");
Function<void, GLuint, GLint, GLsizei, GLint *> FunctionObjects::GetnUniformivARB("glGetnUniformivARB");
Function<void, GLuint, GLint, GLsizei, GLint *> FunctionObjects::GetnUniformivEXT("glGetnUniformivEXT");
...
Function<GLboolean, GLenum, GLuint> FunctionObjects::IsEnablediEXT("glIsEnablediEXT");
...
Function<GLboolean, GLuint> FunctionObjects::IsFramebufferOES("glIsFramebufferOES");
...
Function<GLboolean, GLuint> FunctionObjects::IsProgramPipelineEXT("glIsProgramPipelineEXT");
...
Function<GLboolean, GLuint> FunctionObjects::IsQueryEXT("glIsQueryEXT");
...
Function<GLboolean, GLuint> FunctionObjects::IsRenderbufferOES("glIsRenderbufferOES");
...
Function<GLboolean, GLsync> FunctionObjects::IsSyncAPPLE("glIsSyncAPPLE");
...
Function<GLboolean, GLuint> FunctionObjects::IsVertexArrayOES("glIsVertexArrayOES");
...
Function<void, GLenum, GLfixed> FunctionObjects::LightModelx("glLightModelx");
Function<void, GLenum, GLfixed> FunctionObjects::LightModelxOES("glLightModelxOES");
Function<void, GLenum, const GLfixed *> FunctionObjects::LightModelxv("glLightModelxv");
...
Function<void, GLenum, GLenum, GLfixed> FunctionObjects::Lightx("glLightx");
Function<void, GLenum, GLenum, GLfixed> FunctionObjects::LightxOES("glLightxOES");
Function<void, GLenum, GLenum, const GLfixed *> FunctionObjects::Lightxv("glLightxv");
...
Function<void, GLfixed> FunctionObjects::LineWidthx("glLineWidthx");
...
Function<void, const GLfixed *> FunctionObjects::LoadMatrixx("glLoadMatrixx");
...
Function<void> FunctionObjects::LoadPaletteFromModelViewMatrixOES("glLoadPaletteFromModelViewMatrixOES");
...
Function<void *, GLenum, GLenum> FunctionObjects::MapBufferOES("glMapBufferOES");
Function<void *, GLenum, GLintptr, GLsizeiptr, GLbitfield> FunctionObjects::MapBufferRange("glMapBufferRange");
Function<void *, GLenum, GLintptr, GLsizeiptr, GLbitfield> FunctionObjects::MapBufferRangeEXT("glMapBufferRangeEXT");
...
Function<void, GLenum, GLenum, GLfixed> FunctionObjects::Materialx("glMaterialx");
Function<void, GLenum, GLenum, GLfixed> FunctionObjects::MaterialxOES("glMaterialxOES");
Function<void, GLenum, GLenum, const GLfixed *> FunctionObjects::Materialxv("glMaterialxv");
...
Function<void, GLint, GLenum, GLsizei, const void *> FunctionObjects::MatrixIndexPointerOES("glMatrixIndexPointerOES");
...
Function<void, GLbitfield> FunctionObjects::MemoryBarrierByRegion("glMemoryBarrierByRegion");
...
Function<void, GLfloat> FunctionObjects::MinSampleShadingOES("glMinSampleShadingOES");
...
Function<void, const GLfixed *> FunctionObjects::MultMatrixx("glMultMatrixx");
...
Function<void, GLenum, GLfixed, GLfixed, GLfixed, GLfixed> FunctionObjects::MultiTexCoord4x("glMultiTexCoord4x");
...
Function<void, GLfixed, GLfixed, GLfixed> FunctionObjects::Normal3x("glNormal3x");
...
Function<void, GLenum, GLuint, GLsizei, const GLchar *> FunctionObjects::ObjectLabelKHR("glObjectLabelKHR");
Function<void, const void *, GLsizei, const GLchar *> FunctionObjects::ObjectPtrLabel("glObjectPtrLabel");
Function<void, const void *, GLsizei, const GLchar *> FunctionObjects::ObjectPtrLabelKHR("glObjectPtrLabelKHR");
...
Function<void, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat> FunctionObjects::Orthof("glOrthof");
Function<void, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat> FunctionObjects::OrthofOES("glOrthofOES");
Function<void, GLfixed, GLfixed, GLfixed, GLfixed, GLfixed, GLfixed> FunctionObjects::Orthox("glOrthox");
...
Function<void, GLenum, GLint> FunctionObjects::PatchParameteriEXT("glPatchParameteriEXT");
...
Function<void, GLenum, GLfixed> FunctionObjects::PointParameterx("glPointParameterx");
Function<void, GLenum, GLfixed> FunctionObjects::PointParameterxOES("glPointParameterxOES");
Function<void, GLenum, const GLfixed *> FunctionObjects::PointParameterxv("glPointParameterxv");
...
Function<void, GLenum, GLsizei, const void *> FunctionObjects::PointSizePointerOES("glPointSizePointerOES");
Function<void, GLfixed> FunctionObjects::PointSizex("glPointSizex");
...
Function<void, GLfixed, GLfixed> FunctionObjects::PolygonOffsetx("glPolygonOffsetx");
...
Function<void> FunctionObjects::PopDebugGroupKHR("glPopDebugGroupKHR");
...
Function<void, GLuint, GLenum, const void *, GLint> FunctionObjects::ProgramBinaryOES("glProgramBinaryOES");
...
Function<void, GLenum, GLuint, GLsizei, const GLchar *> FunctionObjects::PushDebugGroupKHR("glPushDebugGroupKHR");
...
Function<void, GLuint, GLenum> FunctionObjects::QueryCounterEXT("glQueryCounterEXT");
...
Function<void, GLenum, GLint> FunctionObjects::ReadBufferIndexedEXT("glReadBufferIndexedEXT");
Function<void, GLenum> FunctionObjects::ReadBufferNV("glReadBufferNV");
...
Function<void, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLsizei, void *> FunctionObjects::ReadnPixelsEXT("glReadnPixelsEXT");
...
Function<void, GLenum, GLsizei, GLenum, GLsizei, GLsizei> FunctionObjects::RenderbufferStorageMultisampleANGLE("glRenderbufferStorageMultisampleANGLE");
Function<void, GLenum, GLsizei, GLenum, GLsizei, GLsizei> FunctionObjects::RenderbufferStorageMultisampleAPPLE("glRenderbufferStorageMultisampleAPPLE");
...
Function<void, GLenum, GLsizei, GLenum, GLsizei, GLsizei> FunctionObjects::RenderbufferStorageMultisampleIMG("glRenderbufferStorageMultisampleIMG");
Function<void, GLenum, GLsizei, GLenum, GLsizei, GLsizei> FunctionObjects::RenderbufferStorageMultisampleNV("glRenderbufferStorageMultisampleNV");
Function<void, GLenum, GLenum, GLsizei, GLsizei> FunctionObjects::RenderbufferStorageOES("glRenderbufferStorageOES");
...
Function<void> FunctionObjects::ResolveMultisampleFramebufferAPPLE("glResolveMultisampleFramebufferAPPLE");
...
Function<void, GLfixed, GLfixed, GLfixed, GLfixed> FunctionObjects::Rotatex("glRotatex");
...
Function<void, GLclampx, GLboolean> FunctionObjects::SampleCoveragex("glSampleCoveragex");
Function<void, GLclampx, GLboolean> FunctionObjects::SampleCoveragexOES("glSampleCoveragexOES");
...
Function<void, GLuint, GLenum, const GLint *> FunctionObjects::SamplerParameterIivEXT("glSamplerParameterIivEXT");
Function<void, GLuint, GLenum, const GLuint *> FunctionObjects::SamplerParameterIuiv("glSamplerParameterIuiv");
Function<void, GLuint, GLenum, const GLuint *> FunctionObjects::SamplerParameterIuivEXT("glSamplerParameterIuivEXT");
...
Function<void, GLfixed, GLfixed, GLfixed> FunctionObjects::Scalex("glScalex");
...
Function<void, GLuint, GLuint, GLuint, GLuint, GLbitfield> FunctionObjects::StartTilingQCOM("glStartTilingQCOM");
...
Function<void, GLenum, GLenum, GLuint, GLintptr, GLsizeiptr> FunctionObjects::TexBufferRangeEXT("glTexBufferRangeEXT");
...
Function<void, GLenum, GLenum, GLfixed> FunctionObjects::TexEnvx("glTexEnvx");
Function<void, GLenum, GLenum, GLfixed> FunctionObjects::TexEnvxOES("glTexEnvxOES");
Function<void, GLenum, GLenum, const GLfixed *> FunctionObjects::TexEnvxv("glTexEnvxv");
...
Function<void, GLenum, GLenum, GLfloat> FunctionObjects::TexGenfOES("glTexGenfOES");
Function<void, GLenum, GLenum, const GLfloat *> FunctionObjects::TexGenfv("glTexGenfv");
Function<void, GLenum, GLenum, const GLfloat *> FunctionObjects::TexGenfvOES("glTexGenfvOES");
Function<void, GLenum, GLenum, GLint> FunctionObjects::TexGeni("glTexGeni");
Function<void, GLenum, GLenum, GLint> FunctionObjects::TexGeniOES("glTexGeniOES");
Function<void, GLenum, GLenum, const GLint *> FunctionObjects::TexGeniv("glTexGeniv");
Function<void, GLenum, GLenum, const GLint *> FunctionObjects::TexGenivOES("glTexGenivOES");
...
Function<void, GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const void *> FunctionObjects::TexImage3DOES("glTexImage3DOES");
...
Function<void, GLenum, GLenum, GLfixed> FunctionObjects::TexParameterx("glTexParameterx");
Function<void, GLenum, GLenum, GLfixed> FunctionObjects::TexParameterxOES("glTexParameterxOES");
Function<void, GLenum, GLenum, const GLfixed *> FunctionObjects::TexParameterxv("glTexParameterxv");
...
Function<void, GLenum, GLsizei, GLenum, GLsizei> FunctionObjects::TexStorage1DEXT("glTexStorage1DEXT");
Function<void, GLenum, GLsizei, GLenum, GLsizei, GLsizei> FunctionObjects::TexStorage2D("glTexStorage2D");
Function<void, GLenum, GLsizei, GLenum, GLsizei, GLsizei> FunctionObjects::TexStorage2DEXT("glTexStorage2DEXT");
...
Function<void, GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei> FunctionObjects::TexStorage3DEXT("glTexStorage3DEXT");
...
Function<void, GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei, GLboolean> FunctionObjects::TexStorage3DMultisampleOES("glTexStorage3DMultisampleOES");
...
Function<void, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const void *> FunctionObjects::TexSubImage3DOES("glTexSubImage3DOES");
...
Function<void, GLfixed, GLfixed, GLfixed> FunctionObjects::Translatex("glTranslatex");
...
Function<void, GLint, GLsizei, GLboolean, const GLfloat *> FunctionObjects::UniformMatrix2x3fvNV("glUniformMatrix2x3fvNV");
...
Function<void, GLint, GLsizei, GLboolean, const GLfloat *> FunctionObjects::UniformMatrix2x4fvNV("glUniformMatrix2x4fvNV");
...
Function<void, GLint, GLsizei, GLboolean, const GLfloat *> FunctionObjects::UniformMatrix3x2fvNV("glUniformMatrix3x2fvNV");
...
Function<void, GLint, GLsizei, GLboolean, const GLfloat *> FunctionObjects::UniformMatrix3x4fvNV("glUniformMatrix3x4fvNV");
...
Function<void, GLint, GLsizei, GLboolean, const GLfloat *> FunctionObjects::UniformMatrix4x2fvNV("glUniformMatrix4x2fvNV");
...
Function<void, GLint, GLsizei, GLboolean, const GLfloat *> FunctionObjects::UniformMatrix4x3fvNV("glUniformMatrix4x3fvNV");
...
Function<GLboolean, GLenum> FunctionObjects::UnmapBufferOES("glUnmapBufferOES");
...
Function<void, GLuint, GLbitfield, GLuint> FunctionObjects::UseProgramStagesEXT("glUseProgramStagesEXT");
...
Function<void, GLuint> FunctionObjects::ValidateProgramPipelineEXT("glValidateProgramPipelineEXT");
...
Function<void, GLuint, GLuint> FunctionObjects::VertexAttribDivisorANGLE("glVertexAttribDivisorANGLE");
Function<void, GLuint, GLuint> FunctionObjects::VertexAttribDivisorARB("glVertexAttribDivisorARB");
Function<void, GLuint, GLuint> FunctionObjects::VertexAttribDivisorEXT("glVertexAttribDivisorEXT");
Function<void, GLuint, GLuint> FunctionObjects::VertexAttribDivisorNV("glVertexAttribDivisorNV");
...
Function<void, GLsync, GLbitfield, GLuint64> FunctionObjects::WaitSyncAPPLE("glWaitSyncAPPLE");
...
Function<void, GLint, GLenum, GLsizei, const void *> FunctionObjects::WeightPointerOES("glWeightPointerOES");
