...
const std::unordered_map<GLenum, std::string> Meta_StringsByEnum =
{
    ...
    { GLenum::GL_VIEWPORT_POSITION_W_SCALE_X_COEFF, "GL_VIEWPORT_POSITION_W_SCALE_X_COEFF" },
    { GLenum::GL_VIEWPORT_POSITION_W_SCALE_Y_COEFF, "GL_VIEWPORT_POSITION_W_SCALE_Y_COEFF" },
