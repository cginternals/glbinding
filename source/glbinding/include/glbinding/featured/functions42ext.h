...
{
    return static_cast<gl42ext::GLenum>(FunctionObjects::CheckFramebufferStatusEXT(target));
}

inline GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return static_cast<gl42ext::GLenum>(FunctionObjects::CheckNamedFramebufferStatusEXT(framebuffer, target));
}
...
{
    return static_cast<gl42ext::GLenum>(FunctionObjects::GetGraphicsResetStatusARB());
}
...
{
    return static_cast<gl42ext::GLenum>(FunctionObjects::ObjectPurgeableAPPLE(objectType, name, option));
}

inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return static_cast<gl42ext::GLenum>(FunctionObjects::ObjectUnpurgeableAPPLE(objectType, name, option));
}
...
{
    return static_cast<gl42ext::GLbitfield>(FunctionObjects::QueryMatrixxOES(mantissa, exponent));
}
...
{
    return static_cast<gl42ext::GLenum>(FunctionObjects::VideoCaptureNV(video_capture_slot, sequence_num, capture_time));
}
