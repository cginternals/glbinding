...
inline void glBlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, gl42::ClearBufferMask mask, gl42::GLenum filter)
{
...
inline void glClear(gl42::ClearBufferMask mask)
{
...
inline GLenum glClientWaitSync(GLsync sync, gl42::SyncObjectMask flags, GLuint64 timeout)
{
...
inline GLsync glFenceSync(gl42::GLenum condition, gl::GenericBitmask flags)
{
...
inline void * glMapBufferRange(gl42::GLenum target, GLintptr offset, GLsizeiptr length, gl42::BufferAccessMask access)
{
...
inline void glMemoryBarrier(gl42::MemoryBarrierMask barriers)
{
...
inline void glPushAttrib(gl42::AttribMask mask)
{
   	return FunctionObjects::PushAttrib(static_cast<gl::GLbitfield>(mask));
}

inline void glPushClientAttrib(gl42::ClientAttribMask mask)
{
...
inline void glUseProgramStages(GLuint pipeline, gl42::UseProgramStageMask stages, GLuint program)
{
