...
{
    return static_cast<gl31ext::GLenum>(glbinding::FunctionObjects::CheckFramebufferStatusEXT(target));
}

inline GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return static_cast<gl31ext::GLenum>(glbinding::FunctionObjects::CheckNamedFramebufferStatusEXT(framebuffer, target));
}
...
{
    return static_cast<gl31ext::GLenum>(glbinding::FunctionObjects::ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl31ext::GLenum>(glbinding::FunctionObjects::GetGraphicsResetStatusARB());
}
...
{
    return static_cast<gl31ext::GLenum>(glbinding::FunctionObjects::ObjectPurgeableAPPLE(objectType, name, option));
}

inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return static_cast<gl31ext::GLenum>(glbinding::FunctionObjects::ObjectUnpurgeableAPPLE(objectType, name, option));
}
...
{
    return static_cast<gl31ext::GLbitfield>(glbinding::FunctionObjects::QueryMatrixxOES(mantissa, exponent));
}
...
{
    return static_cast<gl31ext::GLenum>(glbinding::FunctionObjects::VideoCaptureNV(video_capture_slot, sequence_num, capture_time));
}
