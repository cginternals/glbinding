...
inline GLsync glFenceSync(gl44core::GLenum condition, gl44core::NotUsedMask flags)
{
...
inline void glWaitSync(GLsync sync, gl44core::NotUsedMask flags, GLuint64 timeout)
{
