...
inline void glAlphaFuncx(gl31::GLenum func, GLfixed ref)
{
...
inline void glClipPlanef(gl31::GLenum p, const GLfloat * eqn)
{
   	return FunctionObjects::ClipPlanef(static_cast<gl::GLenum>(p), eqn);
}

inline void glClipPlanex(gl31::GLenum plane, const GLfixed * equation)
{
...
inline void glFogx(gl31::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Fogx(static_cast<gl::GLenum>(pname), param);
}

inline void glFogxv(gl31::GLenum pname, const GLfixed * param)
{
...
inline void glGetClipPlanef(gl31::GLenum plane, GLfloat * equation)
{
   	return FunctionObjects::GetClipPlanef(static_cast<gl::GLenum>(plane), equation);
}

inline void glGetClipPlanex(gl31::GLenum plane, GLfixed * equation)
{
...
inline void glGetFixedv(gl31::GLenum pname, GLfixed * params)
{
...
inline void glGetLightxv(gl31::GLenum light, gl31::GLenum pname, GLfixed * params)
{
...
inline void glGetMaterialxv(gl31::GLenum face, gl31::GLenum pname, GLfixed * params)
{
...
inline void glGetTexEnvxv(gl31::GLenum target, gl31::GLenum pname, GLfixed * params)
{
...
inline void glGetTexParameterxv(gl31::GLenum target, gl31::GLenum pname, GLfixed * params)
{
...
inline void glLightModelx(gl31::GLenum pname, GLfixed param)
{
   	return FunctionObjects::LightModelx(static_cast<gl::GLenum>(pname), param);
}

inline void glLightModelxv(gl31::GLenum pname, const GLfixed * param)
{
...
inline void glLightx(gl31::GLenum light, gl31::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Lightx(static_cast<gl::GLenum>(light), static_cast<gl::GLenum>(pname), param);
}

inline void glLightxv(gl31::GLenum light, gl31::GLenum pname, const GLfixed * params)
{
...
inline void glMaterialx(gl31::GLenum face, gl31::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Materialx(static_cast<gl::GLenum>(face), static_cast<gl::GLenum>(pname), param);
}

inline void glMaterialxv(gl31::GLenum face, gl31::GLenum pname, const GLfixed * param)
{
...
inline void glMemoryBarrierByRegion(gl31::GLbitfield barriers)
{
...
inline void glMultiTexCoord4x(gl31::GLenum texture, GLfixed s, GLfixed t, GLfixed r, GLfixed q)
{
...
inline void glPointParameterx(gl31::GLenum pname, GLfixed param)
{
   	return FunctionObjects::PointParameterx(static_cast<gl::GLenum>(pname), param);
}

inline void glPointParameterxv(gl31::GLenum pname, const GLfixed * params)
{
...
inline void glTexEnvx(gl31::GLenum target, gl31::GLenum pname, GLfixed param)
{
   	return FunctionObjects::TexEnvx(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexEnvxv(gl31::GLenum target, gl31::GLenum pname, const GLfixed * params)
{
...
inline void glTexParameterx(gl31::GLenum target, gl31::GLenum pname, GLfixed param)
{
   	return FunctionObjects::TexParameterx(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexParameterxv(gl31::GLenum target, gl31::GLenum pname, const GLfixed * params)
{
