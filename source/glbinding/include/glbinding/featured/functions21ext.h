...
{
    return static_cast<gl21ext::GLenum>(FunctionObjects::CheckFramebufferStatus(target));
}

inline GLenum glCheckFramebufferStatusEXT(GLenum target)
{
    return static_cast<gl21ext::GLenum>(FunctionObjects::CheckFramebufferStatusEXT(target));
}

inline GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return static_cast<gl21ext::GLenum>(FunctionObjects::CheckNamedFramebufferStatusEXT(framebuffer, target));
}
...
{
    return static_cast<gl21ext::GLenum>(FunctionObjects::ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl21ext::GLenum>(FunctionObjects::GetGraphicsResetStatusARB());
}
...
{
    return static_cast<gl21ext::GLenum>(FunctionObjects::ObjectPurgeableAPPLE(objectType, name, option));
}

inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return static_cast<gl21ext::GLenum>(FunctionObjects::ObjectUnpurgeableAPPLE(objectType, name, option));
}
...
{
    return static_cast<gl21ext::GLbitfield>(FunctionObjects::QueryMatrixxOES(mantissa, exponent));
}
...
{
    return static_cast<gl21ext::GLenum>(FunctionObjects::VideoCaptureNV(video_capture_slot, sequence_num, capture_time));
}
