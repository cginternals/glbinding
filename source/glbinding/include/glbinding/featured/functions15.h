...
inline void glAlphaFuncx(gl15::GLenum func, GLfixed ref)
{
...
inline void glClear(gl15::GLbitfield mask)
{
...
inline void glClipPlanef(gl15::GLenum p, const GLfloat * eqn)
{
   	return FunctionObjects::ClipPlanef(static_cast<gl::GLenum>(p), eqn);
}

inline void glClipPlanex(gl15::GLenum plane, const GLfixed * equation)
{
...
inline void glFogx(gl15::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Fogx(static_cast<gl::GLenum>(pname), param);
}

inline void glFogxv(gl15::GLenum pname, const GLfixed * param)
{
...
inline void glGetClipPlanef(gl15::GLenum plane, GLfloat * equation)
{
   	return FunctionObjects::GetClipPlanef(static_cast<gl::GLenum>(plane), equation);
}

inline void glGetClipPlanex(gl15::GLenum plane, GLfixed * equation)
{
...
inline void glGetFixedv(gl15::GLenum pname, GLfixed * params)
{
...
inline void glGetLightxv(gl15::GLenum light, gl15::GLenum pname, GLfixed * params)
{
...
inline void glGetMaterialxv(gl15::GLenum face, gl15::GLenum pname, GLfixed * params)
{
...
inline void glGetTexEnvxv(gl15::GLenum target, gl15::GLenum pname, GLfixed * params)
{
...
inline void glGetTexParameterxv(gl15::GLenum target, gl15::GLenum pname, GLfixed * params)
{
...
inline void glLightModelx(gl15::GLenum pname, GLfixed param)
{
   	return FunctionObjects::LightModelx(static_cast<gl::GLenum>(pname), param);
}

inline void glLightModelxv(gl15::GLenum pname, const GLfixed * param)
{
...
inline void glLightx(gl15::GLenum light, gl15::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Lightx(static_cast<gl::GLenum>(light), static_cast<gl::GLenum>(pname), param);
}

inline void glLightxv(gl15::GLenum light, gl15::GLenum pname, const GLfixed * params)
{
...
inline void glMaterialx(gl15::GLenum face, gl15::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Materialx(static_cast<gl::GLenum>(face), static_cast<gl::GLenum>(pname), param);
}

inline void glMaterialxv(gl15::GLenum face, gl15::GLenum pname, const GLfixed * param)
{
...
inline void glMultiTexCoord4x(gl15::GLenum texture, GLfixed s, GLfixed t, GLfixed r, GLfixed q)
{
...
inline void glPointParameterx(gl15::GLenum pname, GLfixed param)
{
   	return FunctionObjects::PointParameterx(static_cast<gl::GLenum>(pname), param);
}

inline void glPointParameterxv(gl15::GLenum pname, const GLfixed * params)
{
...
inline void glPushAttrib(gl15::GLbitfield mask)
{
   	return FunctionObjects::PushAttrib(static_cast<gl::GLbitfield>(mask));
}

inline void glPushClientAttrib(gl15::GLbitfield mask)
{
...
inline void glTexEnvx(gl15::GLenum target, gl15::GLenum pname, GLfixed param)
{
   	return FunctionObjects::TexEnvx(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexEnvxv(gl15::GLenum target, gl15::GLenum pname, const GLfixed * params)
{
...
inline void glTexParameterx(gl15::GLenum target, gl15::GLenum pname, GLfixed param)
{
   	return FunctionObjects::TexParameterx(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexParameterxv(gl15::GLenum target, gl15::GLenum pname, const GLfixed * params)
{
