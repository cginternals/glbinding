...
{
   	return static_cast<gl32::GLenum>(FunctionObjects::CheckFramebufferStatus(target));
}
...
{
   	return static_cast<gl32::GLenum>(FunctionObjects::ClientWaitSync(sync, flags, timeout));
}
