...
inline void glAccum(gl32::GLenum op, GLfloat value)
{
   	return FunctionObjects::Accum(static_cast<gl::GLenum>(op), value);
}

inline void glActiveTexture(gl32::GLenum texture)
{
   	return FunctionObjects::ActiveTexture(static_cast<gl::GLenum>(texture));
}

inline void glAlphaFunc(gl32::GLenum func, GLfloat ref)
{
   	return FunctionObjects::AlphaFunc(static_cast<gl::GLenum>(func), ref);
}

inline void glAlphaFuncx(gl32::GLenum func, GLfixed ref)
{
...
inline void glBegin(gl32::GLenum mode)
{
   	return FunctionObjects::Begin(static_cast<gl::GLenum>(mode));
}

inline void glBeginConditionalRender(GLuint id, gl32::GLenum mode)
{
   	return FunctionObjects::BeginConditionalRender(id, static_cast<gl::GLenum>(mode));
}

inline void glBeginQuery(gl32::GLenum target, GLuint id)
{
   	return FunctionObjects::BeginQuery(static_cast<gl::GLenum>(target), id);
}

inline void glBeginTransformFeedback(gl32::GLenum primitiveMode)
{
...
inline void glBindBuffer(gl32::GLenum target, GLuint buffer)
{
   	return FunctionObjects::BindBuffer(static_cast<gl::GLenum>(target), buffer);
}

inline void glBindBufferBase(gl32::GLenum target, GLuint index, GLuint buffer)
{
   	return FunctionObjects::BindBufferBase(static_cast<gl::GLenum>(target), index, buffer);
}

inline void glBindBufferRange(gl32::GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size)
{
...
inline void glBindFramebuffer(gl32::GLenum target, GLuint framebuffer)
{
   	return FunctionObjects::BindFramebuffer(static_cast<gl::GLenum>(target), framebuffer);
}

inline void glBindRenderbuffer(gl32::GLenum target, GLuint renderbuffer)
{
   	return FunctionObjects::BindRenderbuffer(static_cast<gl::GLenum>(target), renderbuffer);
}

inline void glBindTexture(gl32::GLenum target, GLuint texture)
{
...
inline void glBlendEquation(gl32::GLenum mode)
{
   	return FunctionObjects::BlendEquation(static_cast<gl::GLenum>(mode));
}

inline void glBlendEquationSeparate(gl32::GLenum modeRGB, gl32::GLenum modeAlpha)
{
   	return FunctionObjects::BlendEquationSeparate(static_cast<gl::GLenum>(modeRGB), static_cast<gl::GLenum>(modeAlpha));
}

inline void glBlendFunc(gl32::GLenum sfactor, gl32::GLenum dfactor)
{
   	return FunctionObjects::BlendFunc(static_cast<gl::GLenum>(sfactor), static_cast<gl::GLenum>(dfactor));
}

inline void glBlendFuncSeparate(gl32::GLenum sfactorRGB, gl32::GLenum dfactorRGB, gl32::GLenum sfactorAlpha, gl32::GLenum dfactorAlpha)
{
...
inline void glBlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, gl32::GLbitfield mask, gl32::GLenum filter)
{
...
inline void glBufferData(gl32::GLenum target, GLsizeiptr size, const void * data, gl32::GLenum usage)
{
   	return FunctionObjects::BufferData(static_cast<gl::GLenum>(target), size, data, static_cast<gl::GLenum>(usage));
}

inline void glBufferSubData(gl32::GLenum target, GLintptr offset, GLsizeiptr size, const void * data)
{
...
inline void glCallLists(GLsizei n, gl32::GLenum type, const void * lists)
{
   	return FunctionObjects::CallLists(n, static_cast<gl::GLenum>(type), lists);
}

inline GLenum glCheckFramebufferStatus(gl32::GLenum target)
{
   	return static_cast<gl32::GLenum>(FunctionObjects::CheckFramebufferStatus(static_cast<gl::GLenum>(target)));
}

inline void glClampColor(gl32::GLenum target, gl32::GLenum clamp)
{
   	return FunctionObjects::ClampColor(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(clamp));
}

inline void glClear(gl32::GLbitfield mask)
{
...
inline void glClearBufferfi(gl32::GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil)
{
   	return FunctionObjects::ClearBufferfi(static_cast<gl::GLenum>(buffer), drawbuffer, depth, stencil);
}

inline void glClearBufferfv(gl32::GLenum buffer, GLint drawbuffer, const GLfloat * value)
{
   	return FunctionObjects::ClearBufferfv(static_cast<gl::GLenum>(buffer), drawbuffer, value);
}

inline void glClearBufferiv(gl32::GLenum buffer, GLint drawbuffer, const GLint * value)
{
   	return FunctionObjects::ClearBufferiv(static_cast<gl::GLenum>(buffer), drawbuffer, value);
}

inline void glClearBufferuiv(gl32::GLenum buffer, GLint drawbuffer, const GLuint * value)
{
...
inline void glClientActiveTexture(gl32::GLenum texture)
{
   	return FunctionObjects::ClientActiveTexture(static_cast<gl::GLenum>(texture));
}

inline GLenum glClientWaitSync(GLsync sync, gl32::GLbitfield flags, GLuint64 timeout)
{
   	return static_cast<gl32::GLenum>(FunctionObjects::ClientWaitSync(sync, static_cast<gl::GLbitfield>(flags), timeout));
}

inline void glClipPlane(gl32::GLenum plane, const GLdouble * equation)
{
   	return FunctionObjects::ClipPlane(static_cast<gl::GLenum>(plane), equation);
}

inline void glClipPlanef(gl32::GLenum p, const GLfloat * eqn)
{
   	return FunctionObjects::ClipPlanef(static_cast<gl::GLenum>(p), eqn);
}

inline void glClipPlanex(gl32::GLenum plane, const GLfixed * equation)
{
...
inline void glColorMaterial(gl32::GLenum face, gl32::GLenum mode)
{
   	return FunctionObjects::ColorMaterial(static_cast<gl::GLenum>(face), static_cast<gl::GLenum>(mode));
}

inline void glColorPointer(GLint size, gl32::GLenum type, GLsizei stride, const void * pointer)
{
...
inline void glCompressedTexImage1D(gl32::GLenum target, GLint level, gl32::GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void * data)
{
...
inline void glCompressedTexImage2D(gl32::GLenum target, GLint level, gl32::GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void * data)
{
...
inline void glCompressedTexImage3D(gl32::GLenum target, GLint level, gl32::GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void * data)
{
...
inline void glCompressedTexSubImage1D(gl32::GLenum target, GLint level, GLint xoffset, GLsizei width, gl32::GLenum format, GLsizei imageSize, const void * data)
{
...
inline void glCompressedTexSubImage2D(gl32::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, gl32::GLenum format, GLsizei imageSize, const void * data)
{
...
inline void glCompressedTexSubImage3D(gl32::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, gl32::GLenum format, GLsizei imageSize, const void * data)
{
...
inline void glCopyBufferSubData(gl32::GLenum readTarget, gl32::GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size)
{
...
inline void glCopyPixels(GLint x, GLint y, GLsizei width, GLsizei height, gl32::GLenum type)
{
   	return FunctionObjects::CopyPixels(x, y, width, height, static_cast<gl::GLenum>(type));
}

inline void glCopyTexImage1D(gl32::GLenum target, GLint level, gl32::GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border)
{
...
inline void glCopyTexImage2D(gl32::GLenum target, GLint level, gl32::GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border)
{
...
inline void glCopyTexSubImage1D(gl32::GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width)
{
   	return FunctionObjects::CopyTexSubImage1D(static_cast<gl::GLenum>(target), level, xoffset, x, y, width);
}

inline void glCopyTexSubImage2D(gl32::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height)
{
   	return FunctionObjects::CopyTexSubImage2D(static_cast<gl::GLenum>(target), level, xoffset, yoffset, x, y, width, height);
}

inline void glCopyTexSubImage3D(gl32::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height)
{
...
inline GLuint glCreateShader(gl32::GLenum type)
{
   	return FunctionObjects::CreateShader(static_cast<gl::GLenum>(type));
}

inline void glCullFace(gl32::GLenum mode)
{
...
inline void glDepthFunc(gl32::GLenum func)
{
...
inline void glDisable(gl32::GLenum cap)
{
   	return FunctionObjects::Disable(static_cast<gl::GLenum>(cap));
}

inline void glDisableClientState(gl32::GLenum array)
{
...
inline void glDisablei(gl32::GLenum target, GLuint index)
{
   	return FunctionObjects::Disablei(static_cast<gl::GLenum>(target), index);
}

inline void glDrawArrays(gl32::GLenum mode, GLint first, GLsizei count)
{
   	return FunctionObjects::DrawArrays(static_cast<gl::GLenum>(mode), first, count);
}

inline void glDrawArraysInstanced(gl32::GLenum mode, GLint first, GLsizei count, GLsizei instancecount)
{
   	return FunctionObjects::DrawArraysInstanced(static_cast<gl::GLenum>(mode), first, count, instancecount);
}

inline void glDrawBuffer(gl32::GLenum mode)
{
   	return FunctionObjects::DrawBuffer(static_cast<gl::GLenum>(mode));
}

inline void glDrawBuffers(GLsizei n, const gl32::GLenum * bufs)
{
   	return FunctionObjects::DrawBuffers(n, reinterpret_cast<const gl::GLenum *>(bufs));
}

inline void glDrawElements(gl32::GLenum mode, GLsizei count, gl32::GLenum type, const void * indices)
{
   	return FunctionObjects::DrawElements(static_cast<gl::GLenum>(mode), count, static_cast<gl::GLenum>(type), indices);
}

inline void glDrawElementsBaseVertex(gl32::GLenum mode, GLsizei count, gl32::GLenum type, const void * indices, GLint basevertex)
{
...
inline void glDrawElementsInstanced(gl32::GLenum mode, GLsizei count, gl32::GLenum type, const void * indices, GLsizei instancecount)
{
...
inline void glDrawElementsInstancedBaseVertex(gl32::GLenum mode, GLsizei count, gl32::GLenum type, const void * indices, GLsizei instancecount, GLint basevertex)
{
...
inline void glDrawPixels(GLsizei width, GLsizei height, gl32::GLenum format, gl32::GLenum type, const void * pixels)
{
   	return FunctionObjects::DrawPixels(width, height, static_cast<gl::GLenum>(format), static_cast<gl::GLenum>(type), pixels);
}

inline void glDrawRangeElements(gl32::GLenum mode, GLuint start, GLuint end, GLsizei count, gl32::GLenum type, const void * indices)
{
   	return FunctionObjects::DrawRangeElements(static_cast<gl::GLenum>(mode), start, end, count, static_cast<gl::GLenum>(type), indices);
}

inline void glDrawRangeElementsBaseVertex(gl32::GLenum mode, GLuint start, GLuint end, GLsizei count, gl32::GLenum type, const void * indices, GLint basevertex)
{
...
inline void glEnable(gl32::GLenum cap)
{
   	return FunctionObjects::Enable(static_cast<gl::GLenum>(cap));
}

inline void glEnableClientState(gl32::GLenum array)
{
...
inline void glEnablei(gl32::GLenum target, GLuint index)
{
...
inline void glEndQuery(gl32::GLenum target)
{
...
inline void glEvalMesh1(gl32::GLenum mode, GLint i1, GLint i2)
{
   	return FunctionObjects::EvalMesh1(static_cast<gl::GLenum>(mode), i1, i2);
}

inline void glEvalMesh2(gl32::GLenum mode, GLint i1, GLint i2, GLint j1, GLint j2)
{
...
inline void glFeedbackBuffer(GLsizei size, gl32::GLenum type, GLfloat * buffer)
{
   	return FunctionObjects::FeedbackBuffer(size, static_cast<gl::GLenum>(type), buffer);
}

inline GLsync glFenceSync(gl32::GLenum condition, gl32::GLbitfield flags)
{
...
inline void glFlushMappedBufferRange(gl32::GLenum target, GLintptr offset, GLsizeiptr length)
{
   	return FunctionObjects::FlushMappedBufferRange(static_cast<gl::GLenum>(target), offset, length);
}

inline void glFogCoordPointer(gl32::GLenum type, GLsizei stride, const void * pointer)
{
...
inline void glFogf(gl32::GLenum pname, GLfloat param)
{
   	return FunctionObjects::Fogf(static_cast<gl::GLenum>(pname), param);
}

inline void glFogfv(gl32::GLenum pname, const GLfloat * params)
{
   	return FunctionObjects::Fogfv(static_cast<gl::GLenum>(pname), params);
}

inline void glFogi(gl32::GLenum pname, GLint param)
{
   	return FunctionObjects::Fogi(static_cast<gl::GLenum>(pname), param);
}

inline void glFogiv(gl32::GLenum pname, const GLint * params)
{
   	return FunctionObjects::Fogiv(static_cast<gl::GLenum>(pname), params);
}

inline void glFogx(gl32::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Fogx(static_cast<gl::GLenum>(pname), param);
}

inline void glFogxv(gl32::GLenum pname, const GLfixed * param)
{
   	return FunctionObjects::Fogxv(static_cast<gl::GLenum>(pname), param);
}

inline void glFramebufferRenderbuffer(gl32::GLenum target, gl32::GLenum attachment, gl32::GLenum renderbuffertarget, GLuint renderbuffer)
{
...
inline void glFramebufferTexture(gl32::GLenum target, gl32::GLenum attachment, GLuint texture, GLint level)
{
   	return FunctionObjects::FramebufferTexture(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(attachment), texture, level);
}

inline void glFramebufferTexture1D(gl32::GLenum target, gl32::GLenum attachment, gl32::GLenum textarget, GLuint texture, GLint level)
{
...
inline void glFramebufferTexture2D(gl32::GLenum target, gl32::GLenum attachment, gl32::GLenum textarget, GLuint texture, GLint level)
{
...
inline void glFramebufferTexture3D(gl32::GLenum target, gl32::GLenum attachment, gl32::GLenum textarget, GLuint texture, GLint level, GLint zoffset)
{
...
inline void glFramebufferTextureLayer(gl32::GLenum target, gl32::GLenum attachment, GLuint texture, GLint level, GLint layer)
{
...
inline void glFrontFace(gl32::GLenum mode)
{
...
inline void glGenerateMipmap(gl32::GLenum target)
{
   	return FunctionObjects::GenerateMipmap(static_cast<gl::GLenum>(target));
}

inline void glGetActiveAttrib(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, gl32::GLenum * type, GLchar * name)
{
   	return FunctionObjects::GetActiveAttrib(program, index, bufSize, length, size, reinterpret_cast<gl::GLenum *>(type), name);
}

inline void glGetActiveUniform(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, gl32::GLenum * type, GLchar * name)
{
...
inline void glGetActiveUniformBlockiv(GLuint program, GLuint uniformBlockIndex, gl32::GLenum pname, GLint * params)
{
...
inline void glGetActiveUniformsiv(GLuint program, GLsizei uniformCount, const GLuint * uniformIndices, gl32::GLenum pname, GLint * params)
{
...
{
   	return static_cast<gl32::GLenum>(FunctionObjects::GetError());
}

inline void glGetFixedv(gl32::GLenum pname, GLfixed * params)
{
   	return FunctionObjects::GetFixedv(static_cast<gl::GLenum>(pname), params);
}

inline void glGetFloatv(gl32::GLenum pname, GLfloat * data)
{
...
inline void glGetFramebufferAttachmentParameteriv(gl32::GLenum target, gl32::GLenum attachment, gl32::GLenum pname, GLint * params)
{
...
inline void glGetProgramiv(GLuint program, gl32::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetProgramiv(program, static_cast<gl::GLenum>(pname), params);
}

inline void glGetQueryObjectiv(GLuint id, gl32::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetQueryObjectiv(id, static_cast<gl::GLenum>(pname), params);
}

inline void glGetQueryObjectuiv(GLuint id, gl32::GLenum pname, GLuint * params)
{
   	return FunctionObjects::GetQueryObjectuiv(id, static_cast<gl::GLenum>(pname), params);
}

inline void glGetQueryiv(gl32::GLenum target, gl32::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetQueryiv(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), params);
}

inline void glGetRenderbufferParameteriv(gl32::GLenum target, gl32::GLenum pname, GLint * params)
{
...
inline void glGetTexLevelParameterfv(gl32::GLenum target, GLint level, gl32::GLenum pname, GLfloat * params)
{
   	return FunctionObjects::GetTexLevelParameterfv(static_cast<gl::GLenum>(target), level, static_cast<gl::GLenum>(pname), params);
}

inline void glGetTexLevelParameteriv(gl32::GLenum target, GLint level, gl32::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetTexLevelParameteriv(static_cast<gl::GLenum>(target), level, static_cast<gl::GLenum>(pname), params);
}

inline void glGetTexParameterIiv(gl32::GLenum target, gl32::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetTexParameterIiv(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), params);
}

inline void glGetTexParameterIuiv(gl32::GLenum target, gl32::GLenum pname, GLuint * params)
{
   	return FunctionObjects::GetTexParameterIuiv(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), params);
}

inline void glGetTexParameterfv(gl32::GLenum target, gl32::GLenum pname, GLfloat * params)
{
   	return FunctionObjects::GetTexParameterfv(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), params);
}

inline void glGetTexParameteriv(gl32::GLenum target, gl32::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetTexParameteriv(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), params);
}

inline void glGetTexParameterxv(gl32::GLenum target, gl32::GLenum pname, GLfixed * params)
{
   	return FunctionObjects::GetTexParameterxv(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), params);
}

inline void glGetTransformFeedbackVarying(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLsizei * size, gl32::GLenum * type, GLchar * name)
{
...
inline void glGetVertexAttribIiv(GLuint index, gl32::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetVertexAttribIiv(index, static_cast<gl::GLenum>(pname), params);
}

inline void glGetVertexAttribIuiv(GLuint index, gl32::GLenum pname, GLuint * params)
{
   	return FunctionObjects::GetVertexAttribIuiv(index, static_cast<gl::GLenum>(pname), params);
}

inline void glGetVertexAttribPointerv(GLuint index, gl32::GLenum pname, void ** pointer)
{
   	return FunctionObjects::GetVertexAttribPointerv(index, static_cast<gl::GLenum>(pname), pointer);
}

inline void glGetVertexAttribdv(GLuint index, gl32::GLenum pname, GLdouble * params)
{
   	return FunctionObjects::GetVertexAttribdv(index, static_cast<gl::GLenum>(pname), params);
}

inline void glGetVertexAttribfv(GLuint index, gl32::GLenum pname, GLfloat * params)
{
   	return FunctionObjects::GetVertexAttribfv(index, static_cast<gl::GLenum>(pname), params);
}

inline void glGetVertexAttribiv(GLuint index, gl32::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetVertexAttribiv(index, static_cast<gl::GLenum>(pname), params);
}

inline void glHint(gl32::GLenum target, gl32::GLenum mode)
{
...
inline void glIndexPointer(gl32::GLenum type, GLsizei stride, const void * pointer)
{
...
inline void glInterleavedArrays(gl32::GLenum format, GLsizei stride, const void * pointer)
{
...
inline GLboolean glIsEnabled(gl32::GLenum cap)
{
   	return FunctionObjects::IsEnabled(static_cast<gl::GLenum>(cap));
}

inline GLboolean glIsEnabledi(gl32::GLenum target, GLuint index)
{
...
inline void glLogicOp(gl32::GLenum opcode)
{
   	return FunctionObjects::LogicOp(static_cast<gl::GLenum>(opcode));
}

inline void glMap1d(gl32::GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble * points)
{
   	return FunctionObjects::Map1d(static_cast<gl::GLenum>(target), u1, u2, stride, order, points);
}

inline void glMap1f(gl32::GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat * points)
{
   	return FunctionObjects::Map1f(static_cast<gl::GLenum>(target), u1, u2, stride, order, points);
}

inline void glMap2d(gl32::GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble * points)
{
   	return FunctionObjects::Map2d(static_cast<gl::GLenum>(target), u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
}

inline void glMap2f(gl32::GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat * points)
{
   	return FunctionObjects::Map2f(static_cast<gl::GLenum>(target), u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
}

inline void * glMapBuffer(gl32::GLenum target, gl32::GLenum access)
{
   	return FunctionObjects::MapBuffer(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(access));
}

inline void * glMapBufferRange(gl32::GLenum target, GLintptr offset, GLsizeiptr length, gl32::GLbitfield access)
{
...
inline void glMultiDrawArrays(gl32::GLenum mode, const GLint * first, const GLsizei * count, GLsizei drawcount)
{
   	return FunctionObjects::MultiDrawArrays(static_cast<gl::GLenum>(mode), first, count, drawcount);
}

inline void glMultiDrawElements(gl32::GLenum mode, const GLsizei * count, gl32::GLenum type, const void *const* indices, GLsizei drawcount)
{
   	return FunctionObjects::MultiDrawElements(static_cast<gl::GLenum>(mode), count, static_cast<gl::GLenum>(type), indices, drawcount);
}

inline void glMultiDrawElementsBaseVertex(gl32::GLenum mode, const GLsizei * count, gl32::GLenum type, const void *const* indices, GLsizei drawcount, const GLint * basevertex)
{
...
inline void glNormalPointer(gl32::GLenum type, GLsizei stride, const void * pointer)
{
...
inline void glPixelMapfv(gl32::GLenum map, GLsizei mapsize, const GLfloat * values)
{
   	return FunctionObjects::PixelMapfv(static_cast<gl::GLenum>(map), mapsize, values);
}

inline void glPixelMapuiv(gl32::GLenum map, GLsizei mapsize, const GLuint * values)
{
   	return FunctionObjects::PixelMapuiv(static_cast<gl::GLenum>(map), mapsize, values);
}

inline void glPixelMapusv(gl32::GLenum map, GLsizei mapsize, const GLushort * values)
{
   	return FunctionObjects::PixelMapusv(static_cast<gl::GLenum>(map), mapsize, values);
}

inline void glPixelStoref(gl32::GLenum pname, GLfloat param)
{
   	return FunctionObjects::PixelStoref(static_cast<gl::GLenum>(pname), param);
}

inline void glPixelStorei(gl32::GLenum pname, GLint param)
{
   	return FunctionObjects::PixelStorei(static_cast<gl::GLenum>(pname), param);
}

inline void glPixelTransferf(gl32::GLenum pname, GLfloat param)
{
   	return FunctionObjects::PixelTransferf(static_cast<gl::GLenum>(pname), param);
}

inline void glPixelTransferi(gl32::GLenum pname, GLint param)
{
...
inline void glPointParameterf(gl32::GLenum pname, GLfloat param)
{
   	return FunctionObjects::PointParameterf(static_cast<gl::GLenum>(pname), param);
}

inline void glPointParameterfv(gl32::GLenum pname, const GLfloat * params)
{
   	return FunctionObjects::PointParameterfv(static_cast<gl::GLenum>(pname), params);
}

inline void glPointParameteri(gl32::GLenum pname, GLint param)
{
   	return FunctionObjects::PointParameteri(static_cast<gl::GLenum>(pname), param);
}

inline void glPointParameteriv(gl32::GLenum pname, const GLint * params)
{
   	return FunctionObjects::PointParameteriv(static_cast<gl::GLenum>(pname), params);
}

inline void glPointParameterx(gl32::GLenum pname, GLfixed param)
{
   	return FunctionObjects::PointParameterx(static_cast<gl::GLenum>(pname), param);
}

inline void glPointParameterxv(gl32::GLenum pname, const GLfixed * params)
{
...
inline void glPolygonMode(gl32::GLenum face, gl32::GLenum mode)
{
...
inline void glProvokingVertex(gl32::GLenum mode)
{
   	return FunctionObjects::ProvokingVertex(static_cast<gl::GLenum>(mode));
}

inline void glPushAttrib(gl32::GLbitfield mask)
{
   	return FunctionObjects::PushAttrib(static_cast<gl::GLbitfield>(mask));
}

inline void glPushClientAttrib(gl32::GLbitfield mask)
{
...
inline void glReadBuffer(gl32::GLenum mode)
{
   	return FunctionObjects::ReadBuffer(static_cast<gl::GLenum>(mode));
}

inline void glReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, gl32::GLenum format, gl32::GLenum type, void * pixels)
{
...
inline GLint glRenderMode(gl32::GLenum mode)
{
   	return FunctionObjects::RenderMode(static_cast<gl::GLenum>(mode));
}

inline void glRenderbufferStorage(gl32::GLenum target, gl32::GLenum internalformat, GLsizei width, GLsizei height)
{
...
inline void glRenderbufferStorageMultisample(gl32::GLenum target, GLsizei samples, gl32::GLenum internalformat, GLsizei width, GLsizei height)
{
...
inline void glSampleMaski(GLuint maskNumber, gl32::GLbitfield mask)
{
...
inline void glSecondaryColorPointer(GLint size, gl32::GLenum type, GLsizei stride, const void * pointer)
{
...
inline void glShadeModel(gl32::GLenum mode)
{
...
inline void glStencilFunc(gl32::GLenum func, GLint ref, GLuint mask)
{
   	return FunctionObjects::StencilFunc(static_cast<gl::GLenum>(func), ref, mask);
}

inline void glStencilFuncSeparate(gl32::GLenum face, gl32::GLenum func, GLint ref, GLuint mask)
{
...
inline void glStencilMaskSeparate(gl32::GLenum face, GLuint mask)
{
   	return FunctionObjects::StencilMaskSeparate(static_cast<gl::GLenum>(face), mask);
}

inline void glStencilOp(gl32::GLenum fail, gl32::GLenum zfail, gl32::GLenum zpass)
{
   	return FunctionObjects::StencilOp(static_cast<gl::GLenum>(fail), static_cast<gl::GLenum>(zfail), static_cast<gl::GLenum>(zpass));
}

inline void glStencilOpSeparate(gl32::GLenum face, gl32::GLenum sfail, gl32::GLenum dpfail, gl32::GLenum dppass)
{
...
inline void glTexBuffer(gl32::GLenum target, gl32::GLenum internalformat, GLuint buffer)
{
...
inline void glTexImage2D(gl32::GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, gl32::GLenum format, gl32::GLenum type, const void * pixels)
{
...
inline void glTexImage2DMultisample(gl32::GLenum target, GLsizei samples, gl32::GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations)
{
...
inline void glTexImage3D(gl32::GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, gl32::GLenum format, gl32::GLenum type, const void * pixels)
{
...
inline void glTexImage3DMultisample(gl32::GLenum target, GLsizei samples, gl32::GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations)
{
...
inline void glTexSubImage2D(gl32::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, gl32::GLenum format, gl32::GLenum type, const void * pixels)
{
...
inline void glTexSubImage3D(gl32::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, gl32::GLenum format, gl32::GLenum type, const void * pixels)
{
...
inline void glTransformFeedbackVaryings(GLuint program, GLsizei count, const GLchar *const* varyings, gl32::GLenum bufferMode)
{
...
inline GLboolean glUnmapBuffer(gl32::GLenum target)
{
...
inline void glVertexAttribIPointer(GLuint index, GLint size, gl32::GLenum type, GLsizei stride, const void * pointer)
{
   	return FunctionObjects::VertexAttribIPointer(index, size, static_cast<gl::GLenum>(type), stride, pointer);
}

inline void glVertexAttribPointer(GLuint index, GLint size, gl32::GLenum type, GLboolean normalized, GLsizei stride, const void * pointer)
{
   	return FunctionObjects::VertexAttribPointer(index, size, static_cast<gl::GLenum>(type), normalized, stride, pointer);
}

inline void glVertexPointer(GLint size, gl32::GLenum type, GLsizei stride, const void * pointer)
{
...
inline void glWaitSync(GLsync sync, gl32::GLbitfield flags, GLuint64 timeout)
{
