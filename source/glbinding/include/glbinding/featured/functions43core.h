...
inline void glBlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, gl43core::ClearBufferMask mask, gl43core::GLenum filter)
{
...
{
   	return static_cast<gl43core::GLenum>(FunctionObjects::CheckFramebufferStatus(target));
}
...
inline void glClear(gl43core::ClearBufferMask mask)
{
...
inline GLenum glClientWaitSync(GLsync sync, gl43core::SyncObjectMask flags, GLuint64 timeout)
{
   	return static_cast<gl43core::GLenum>(FunctionObjects::ClientWaitSync(sync, flags, timeout));
}
...
inline GLsync glFenceSync(gl43core::GLenum condition, gl43core::NotUsedMask flags)
{
...
inline void * glMapBufferRange(gl43core::GLenum target, GLintptr offset, GLsizeiptr length, gl43core::BufferAccessMask access)
{
   	return FunctionObjects::MapBufferRange(target, offset, length, access);
}

inline void glMemoryBarrier(gl43core::MemoryBarrierMask barriers)
{
...
inline void glUseProgramStages(GLuint pipeline, gl43core::UseProgramStageMask stages, GLuint program)
{
...
inline void glWaitSync(GLsync sync, gl43core::NotUsedMask flags, GLuint64 timeout)
{
