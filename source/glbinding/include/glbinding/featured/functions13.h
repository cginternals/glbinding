...
inline void glAlphaFuncx(gl13::GLenum func, GLfixed ref)
{
...
inline void glClipPlanef(gl13::GLenum p, const GLfloat * eqn)
{
   	return FunctionObjects::ClipPlanef(static_cast<gl::GLenum>(p), eqn);
}

inline void glClipPlanex(gl13::GLenum plane, const GLfixed * equation)
{
...
inline void glFogx(gl13::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Fogx(static_cast<gl::GLenum>(pname), param);
}

inline void glFogxv(gl13::GLenum pname, const GLfixed * param)
{
...
inline void glGetClipPlanef(gl13::GLenum plane, GLfloat * equation)
{
   	return FunctionObjects::GetClipPlanef(static_cast<gl::GLenum>(plane), equation);
}

inline void glGetClipPlanex(gl13::GLenum plane, GLfixed * equation)
{
...
{
   	return static_cast<gl13::GLenum>(FunctionObjects::GetError());
}

inline void glGetFixedv(gl13::GLenum pname, GLfixed * params)
{
...
inline void glGetLightxv(gl13::GLenum light, gl13::GLenum pname, GLfixed * params)
{
...
inline void glGetMaterialxv(gl13::GLenum face, gl13::GLenum pname, GLfixed * params)
{
...
inline void glGetTexEnvxv(gl13::GLenum target, gl13::GLenum pname, GLfixed * params)
{
...
inline void glGetTexParameterxv(gl13::GLenum target, gl13::GLenum pname, GLfixed * params)
{
...
inline void glLightModelx(gl13::GLenum pname, GLfixed param)
{
   	return FunctionObjects::LightModelx(static_cast<gl::GLenum>(pname), param);
}

inline void glLightModelxv(gl13::GLenum pname, const GLfixed * param)
{
...
inline void glLightx(gl13::GLenum light, gl13::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Lightx(static_cast<gl::GLenum>(light), static_cast<gl::GLenum>(pname), param);
}

inline void glLightxv(gl13::GLenum light, gl13::GLenum pname, const GLfixed * params)
{
...
inline void glMaterialx(gl13::GLenum face, gl13::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Materialx(static_cast<gl::GLenum>(face), static_cast<gl::GLenum>(pname), param);
}

inline void glMaterialxv(gl13::GLenum face, gl13::GLenum pname, const GLfixed * param)
{
...
inline void glMultiTexCoord4x(gl13::GLenum texture, GLfixed s, GLfixed t, GLfixed r, GLfixed q)
{
...
inline void glPointParameterx(gl13::GLenum pname, GLfixed param)
{
   	return FunctionObjects::PointParameterx(static_cast<gl::GLenum>(pname), param);
}

inline void glPointParameterxv(gl13::GLenum pname, const GLfixed * params)
{
...
inline void glTexEnvx(gl13::GLenum target, gl13::GLenum pname, GLfixed param)
{
   	return FunctionObjects::TexEnvx(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexEnvxv(gl13::GLenum target, gl13::GLenum pname, const GLfixed * params)
{
...
inline void glTexParameterx(gl13::GLenum target, gl13::GLenum pname, GLfixed param)
{
   	return FunctionObjects::TexParameterx(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexParameterxv(gl13::GLenum target, gl13::GLenum pname, const GLfixed * params)
{
