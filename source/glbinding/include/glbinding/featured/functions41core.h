...
inline void glAlphaFuncx(gl41core::GLenum func, GLfixed ref)
{
...
inline void glClipPlanef(gl41core::GLenum p, const GLfloat * eqn)
{
   	return FunctionObjects::ClipPlanef(static_cast<gl::GLenum>(p), eqn);
}

inline void glClipPlanex(gl41core::GLenum plane, const GLfixed * equation)
{
...
inline void glFogx(gl41core::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Fogx(static_cast<gl::GLenum>(pname), param);
}

inline void glFogxv(gl41core::GLenum pname, const GLfixed * param)
{
...
inline void glGetClipPlanef(gl41core::GLenum plane, GLfloat * equation)
{
   	return FunctionObjects::GetClipPlanef(static_cast<gl::GLenum>(plane), equation);
}

inline void glGetClipPlanex(gl41core::GLenum plane, GLfixed * equation)
{
...
inline void glGetFixedv(gl41core::GLenum pname, GLfixed * params)
{
...
inline void glGetLightxv(gl41core::GLenum light, gl41core::GLenum pname, GLfixed * params)
{
   	return FunctionObjects::GetLightxv(static_cast<gl::GLenum>(light), static_cast<gl::GLenum>(pname), params);
}

inline void glGetMaterialxv(gl41core::GLenum face, gl41core::GLenum pname, GLfixed * params)
{
...
inline void glGetTexEnvxv(gl41core::GLenum target, gl41core::GLenum pname, GLfixed * params)
{
...
inline void glGetTexParameterxv(gl41core::GLenum target, gl41core::GLenum pname, GLfixed * params)
{
...
inline void glLightModelx(gl41core::GLenum pname, GLfixed param)
{
   	return FunctionObjects::LightModelx(static_cast<gl::GLenum>(pname), param);
}

inline void glLightModelxv(gl41core::GLenum pname, const GLfixed * param)
{
   	return FunctionObjects::LightModelxv(static_cast<gl::GLenum>(pname), param);
}

inline void glLightx(gl41core::GLenum light, gl41core::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Lightx(static_cast<gl::GLenum>(light), static_cast<gl::GLenum>(pname), param);
}

inline void glLightxv(gl41core::GLenum light, gl41core::GLenum pname, const GLfixed * params)
{
...
inline void glMaterialx(gl41core::GLenum face, gl41core::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Materialx(static_cast<gl::GLenum>(face), static_cast<gl::GLenum>(pname), param);
}

inline void glMaterialxv(gl41core::GLenum face, gl41core::GLenum pname, const GLfixed * param)
{
   	return FunctionObjects::Materialxv(static_cast<gl::GLenum>(face), static_cast<gl::GLenum>(pname), param);
}

inline void glMemoryBarrierByRegion(gl41core::GLbitfield barriers)
{
...
inline void glMultiTexCoord4x(gl41core::GLenum texture, GLfixed s, GLfixed t, GLfixed r, GLfixed q)
{
...
inline void glPointParameterx(gl41core::GLenum pname, GLfixed param)
{
   	return FunctionObjects::PointParameterx(static_cast<gl::GLenum>(pname), param);
}

inline void glPointParameterxv(gl41core::GLenum pname, const GLfixed * params)
{
...
inline void glTexEnvx(gl41core::GLenum target, gl41core::GLenum pname, GLfixed param)
{
   	return FunctionObjects::TexEnvx(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexEnvxv(gl41core::GLenum target, gl41core::GLenum pname, const GLfixed * params)
{
...
inline void glTexParameterx(gl41core::GLenum target, gl41core::GLenum pname, GLfixed param)
{
   	return FunctionObjects::TexParameterx(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexParameterxv(gl41core::GLenum target, gl41core::GLenum pname, const GLfixed * params)
{
