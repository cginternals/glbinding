...
inline void glAlphaFuncx(gl41::GLenum func, GLfixed ref)
{
...
inline void glBlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, gl41::GLbitfield mask, gl41::GLenum filter)
{
...
inline void glClear(gl41::GLbitfield mask)
{
...
inline GLenum glClientWaitSync(GLsync sync, gl41::GLbitfield flags, GLuint64 timeout)
{
...
inline void glClipPlanef(gl41::GLenum p, const GLfloat * eqn)
{
   	return FunctionObjects::ClipPlanef(static_cast<gl::GLenum>(p), eqn);
}

inline void glClipPlanex(gl41::GLenum plane, const GLfixed * equation)
{
...
inline GLsync glFenceSync(gl41::GLenum condition, gl41::GLbitfield flags)
{
...
inline void glFogx(gl41::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Fogx(static_cast<gl::GLenum>(pname), param);
}

inline void glFogxv(gl41::GLenum pname, const GLfixed * param)
{
...
inline void glGetClipPlanef(gl41::GLenum plane, GLfloat * equation)
{
   	return FunctionObjects::GetClipPlanef(static_cast<gl::GLenum>(plane), equation);
}

inline void glGetClipPlanex(gl41::GLenum plane, GLfixed * equation)
{
...
inline void glGetFixedv(gl41::GLenum pname, GLfixed * params)
{
...
inline void glGetLightxv(gl41::GLenum light, gl41::GLenum pname, GLfixed * params)
{
...
inline void glGetMaterialxv(gl41::GLenum face, gl41::GLenum pname, GLfixed * params)
{
...
inline void glGetTexEnvxv(gl41::GLenum target, gl41::GLenum pname, GLfixed * params)
{
...
inline void glGetTexParameterxv(gl41::GLenum target, gl41::GLenum pname, GLfixed * params)
{
...
inline void glLightModelx(gl41::GLenum pname, GLfixed param)
{
   	return FunctionObjects::LightModelx(static_cast<gl::GLenum>(pname), param);
}

inline void glLightModelxv(gl41::GLenum pname, const GLfixed * param)
{
...
inline void glLightx(gl41::GLenum light, gl41::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Lightx(static_cast<gl::GLenum>(light), static_cast<gl::GLenum>(pname), param);
}

inline void glLightxv(gl41::GLenum light, gl41::GLenum pname, const GLfixed * params)
{
...
inline void * glMapBufferRange(gl41::GLenum target, GLintptr offset, GLsizeiptr length, gl41::GLbitfield access)
{
...
inline void glMaterialx(gl41::GLenum face, gl41::GLenum pname, GLfixed param)
{
   	return FunctionObjects::Materialx(static_cast<gl::GLenum>(face), static_cast<gl::GLenum>(pname), param);
}

inline void glMaterialxv(gl41::GLenum face, gl41::GLenum pname, const GLfixed * param)
{
...
inline void glMemoryBarrierByRegion(gl41::GLbitfield barriers)
{
...
inline void glMultiTexCoord4x(gl41::GLenum texture, GLfixed s, GLfixed t, GLfixed r, GLfixed q)
{
...
inline void glPointParameterx(gl41::GLenum pname, GLfixed param)
{
   	return FunctionObjects::PointParameterx(static_cast<gl::GLenum>(pname), param);
}

inline void glPointParameterxv(gl41::GLenum pname, const GLfixed * params)
{
...
inline void glPushAttrib(gl41::GLbitfield mask)
{
   	return FunctionObjects::PushAttrib(static_cast<gl::GLbitfield>(mask));
}

inline void glPushClientAttrib(gl41::GLbitfield mask)
{
...
inline void glSampleMaski(GLuint maskNumber, gl41::GLbitfield mask)
{
...
inline void glTexEnvx(gl41::GLenum target, gl41::GLenum pname, GLfixed param)
{
   	return FunctionObjects::TexEnvx(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexEnvxv(gl41::GLenum target, gl41::GLenum pname, const GLfixed * params)
{
...
inline void glTexParameterx(gl41::GLenum target, gl41::GLenum pname, GLfixed param)
{
   	return FunctionObjects::TexParameterx(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexParameterxv(gl41::GLenum target, gl41::GLenum pname, const GLfixed * params)
{
...
inline void glUseProgramStages(GLuint pipeline, gl41::GLbitfield stages, GLuint program)
{
...
inline void glWaitSync(GLsync sync, gl41::GLbitfield flags, GLuint64 timeout)
{
