...
inline GLsync glFenceSync(gl40core::GLenum condition, gl40core::NotUsedMask flags)
{
...
inline void glWaitSync(GLsync sync, gl40core::NotUsedMask flags, GLuint64 timeout)
{
