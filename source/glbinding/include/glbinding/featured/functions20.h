...
inline void glAccum(gl20::GLenum op, GLfloat value)
{
   	return FunctionObjects::Accum(static_cast<gl::GLenum>(op), value);
}

inline void glActiveTexture(gl20::GLenum texture)
{
   	return FunctionObjects::ActiveTexture(static_cast<gl::GLenum>(texture));
}

inline void glAlphaFunc(gl20::GLenum func, GLfloat ref)
{
   	return FunctionObjects::AlphaFunc(static_cast<gl::GLenum>(func), ref);
}

inline void glAlphaFuncx(gl20::GLenum func, GLfixed ref)
{
...
inline void glBegin(gl20::GLenum mode)
{
   	return FunctionObjects::Begin(static_cast<gl::GLenum>(mode));
}

inline void glBeginQuery(gl20::GLenum target, GLuint id)
{
...
inline void glBindBuffer(gl20::GLenum target, GLuint buffer)
{
   	return FunctionObjects::BindBuffer(static_cast<gl::GLenum>(target), buffer);
}

inline void glBindTexture(gl20::GLenum target, GLuint texture)
{
...
inline void glBlendEquation(gl20::GLenum mode)
{
   	return FunctionObjects::BlendEquation(static_cast<gl::GLenum>(mode));
}

inline void glBlendEquationSeparate(gl20::GLenum modeRGB, gl20::GLenum modeAlpha)
{
   	return FunctionObjects::BlendEquationSeparate(static_cast<gl::GLenum>(modeRGB), static_cast<gl::GLenum>(modeAlpha));
}

inline void glBlendFunc(gl20::GLenum sfactor, gl20::GLenum dfactor)
{
   	return FunctionObjects::BlendFunc(static_cast<gl::GLenum>(sfactor), static_cast<gl::GLenum>(dfactor));
}

inline void glBlendFuncSeparate(gl20::GLenum sfactorRGB, gl20::GLenum dfactorRGB, gl20::GLenum sfactorAlpha, gl20::GLenum dfactorAlpha)
{
...
inline void glBufferData(gl20::GLenum target, GLsizeiptr size, const void * data, gl20::GLenum usage)
{
   	return FunctionObjects::BufferData(static_cast<gl::GLenum>(target), size, data, static_cast<gl::GLenum>(usage));
}

inline void glBufferSubData(gl20::GLenum target, GLintptr offset, GLsizeiptr size, const void * data)
{
...
inline void glCallLists(GLsizei n, gl20::GLenum type, const void * lists)
{
   	return FunctionObjects::CallLists(n, static_cast<gl::GLenum>(type), lists);
}

inline void glClear(gl20::GLbitfield mask)
{
...
inline void glClientActiveTexture(gl20::GLenum texture)
{
   	return FunctionObjects::ClientActiveTexture(static_cast<gl::GLenum>(texture));
}

inline void glClipPlane(gl20::GLenum plane, const GLdouble * equation)
{
   	return FunctionObjects::ClipPlane(static_cast<gl::GLenum>(plane), equation);
}

inline void glClipPlanef(gl20::GLenum p, const GLfloat * eqn)
{
   	return FunctionObjects::ClipPlanef(static_cast<gl::GLenum>(p), eqn);
}

inline void glClipPlanex(gl20::GLenum plane, const GLfixed * equation)
{
...
inline void glColorMaterial(gl20::GLenum face, gl20::GLenum mode)
{
   	return FunctionObjects::ColorMaterial(static_cast<gl::GLenum>(face), static_cast<gl::GLenum>(mode));
}

inline void glColorPointer(GLint size, gl20::GLenum type, GLsizei stride, const void * pointer)
{
...
inline void glCompressedTexImage1D(gl20::GLenum target, GLint level, gl20::GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void * data)
{
...
inline void glCompressedTexImage2D(gl20::GLenum target, GLint level, gl20::GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void * data)
{
...
inline void glCompressedTexImage3D(gl20::GLenum target, GLint level, gl20::GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void * data)
{
...
inline void glCompressedTexSubImage1D(gl20::GLenum target, GLint level, GLint xoffset, GLsizei width, gl20::GLenum format, GLsizei imageSize, const void * data)
{
...
inline void glCompressedTexSubImage2D(gl20::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, gl20::GLenum format, GLsizei imageSize, const void * data)
{
...
inline void glCompressedTexSubImage3D(gl20::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, gl20::GLenum format, GLsizei imageSize, const void * data)
{
...
inline void glCopyPixels(GLint x, GLint y, GLsizei width, GLsizei height, gl20::GLenum type)
{
   	return FunctionObjects::CopyPixels(x, y, width, height, static_cast<gl::GLenum>(type));
}

inline void glCopyTexImage1D(gl20::GLenum target, GLint level, gl20::GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border)
{
...
inline void glCopyTexImage2D(gl20::GLenum target, GLint level, gl20::GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border)
{
...
inline void glCopyTexSubImage1D(gl20::GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width)
{
   	return FunctionObjects::CopyTexSubImage1D(static_cast<gl::GLenum>(target), level, xoffset, x, y, width);
}

inline void glCopyTexSubImage2D(gl20::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height)
{
   	return FunctionObjects::CopyTexSubImage2D(static_cast<gl::GLenum>(target), level, xoffset, yoffset, x, y, width, height);
}

inline void glCopyTexSubImage3D(gl20::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height)
{
...
inline GLuint glCreateShader(gl20::GLenum type)
{
   	return FunctionObjects::CreateShader(static_cast<gl::GLenum>(type));
}

inline void glCullFace(gl20::GLenum mode)
{
...
inline void glDepthFunc(gl20::GLenum func)
{
...
inline void glDisable(gl20::GLenum cap)
{
   	return FunctionObjects::Disable(static_cast<gl::GLenum>(cap));
}

inline void glDisableClientState(gl20::GLenum array)
{
...
inline void glDrawArrays(gl20::GLenum mode, GLint first, GLsizei count)
{
   	return FunctionObjects::DrawArrays(static_cast<gl::GLenum>(mode), first, count);
}

inline void glDrawBuffer(gl20::GLenum mode)
{
   	return FunctionObjects::DrawBuffer(static_cast<gl::GLenum>(mode));
}

inline void glDrawBuffers(GLsizei n, const gl20::GLenum * bufs)
{
   	return FunctionObjects::DrawBuffers(n, reinterpret_cast<const gl::GLenum *>(bufs));
}

inline void glDrawElements(gl20::GLenum mode, GLsizei count, gl20::GLenum type, const void * indices)
{
   	return FunctionObjects::DrawElements(static_cast<gl::GLenum>(mode), count, static_cast<gl::GLenum>(type), indices);
}

inline void glDrawPixels(GLsizei width, GLsizei height, gl20::GLenum format, gl20::GLenum type, const void * pixels)
{
   	return FunctionObjects::DrawPixels(width, height, static_cast<gl::GLenum>(format), static_cast<gl::GLenum>(type), pixels);
}

inline void glDrawRangeElements(gl20::GLenum mode, GLuint start, GLuint end, GLsizei count, gl20::GLenum type, const void * indices)
{
...
inline void glEnable(gl20::GLenum cap)
{
   	return FunctionObjects::Enable(static_cast<gl::GLenum>(cap));
}

inline void glEnableClientState(gl20::GLenum array)
{
...
inline void glEndQuery(gl20::GLenum target)
{
...
inline void glEvalMesh1(gl20::GLenum mode, GLint i1, GLint i2)
{
   	return FunctionObjects::EvalMesh1(static_cast<gl::GLenum>(mode), i1, i2);
}

inline void glEvalMesh2(gl20::GLenum mode, GLint i1, GLint i2, GLint j1, GLint j2)
{
...
inline void glFeedbackBuffer(GLsizei size, gl20::GLenum type, GLfloat * buffer)
{
...
inline void glFogCoordPointer(gl20::GLenum type, GLsizei stride, const void * pointer)
{
...
inline void glGetActiveAttrib(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, gl20::GLenum * type, GLchar * name)
{
   	return FunctionObjects::GetActiveAttrib(program, index, bufSize, length, size, reinterpret_cast<gl::GLenum *>(type), name);
}

inline void glGetActiveUniform(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, gl20::GLenum * type, GLchar * name)
{
...
inline void glGetProgramiv(GLuint program, gl20::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetProgramiv(program, static_cast<gl::GLenum>(pname), params);
}

inline void glGetQueryObjectiv(GLuint id, gl20::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetQueryObjectiv(id, static_cast<gl::GLenum>(pname), params);
}

inline void glGetQueryObjectuiv(GLuint id, gl20::GLenum pname, GLuint * params)
{
   	return FunctionObjects::GetQueryObjectuiv(id, static_cast<gl::GLenum>(pname), params);
}

inline void glGetQueryiv(gl20::GLenum target, gl20::GLenum pname, GLint * params)
{
...
inline void glGetTexLevelParameterfv(gl20::GLenum target, GLint level, gl20::GLenum pname, GLfloat * params)
{
   	return FunctionObjects::GetTexLevelParameterfv(static_cast<gl::GLenum>(target), level, static_cast<gl::GLenum>(pname), params);
}

inline void glGetTexLevelParameteriv(gl20::GLenum target, GLint level, gl20::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetTexLevelParameteriv(static_cast<gl::GLenum>(target), level, static_cast<gl::GLenum>(pname), params);
}

inline void glGetTexParameterfv(gl20::GLenum target, gl20::GLenum pname, GLfloat * params)
{
   	return FunctionObjects::GetTexParameterfv(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), params);
}

inline void glGetTexParameteriv(gl20::GLenum target, gl20::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetTexParameteriv(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), params);
}

inline void glGetTexParameterxv(gl20::GLenum target, gl20::GLenum pname, GLfixed * params)
{
...
inline void glGetVertexAttribPointerv(GLuint index, gl20::GLenum pname, void ** pointer)
{
   	return FunctionObjects::GetVertexAttribPointerv(index, static_cast<gl::GLenum>(pname), pointer);
}

inline void glGetVertexAttribdv(GLuint index, gl20::GLenum pname, GLdouble * params)
{
   	return FunctionObjects::GetVertexAttribdv(index, static_cast<gl::GLenum>(pname), params);
}

inline void glGetVertexAttribfv(GLuint index, gl20::GLenum pname, GLfloat * params)
{
   	return FunctionObjects::GetVertexAttribfv(index, static_cast<gl::GLenum>(pname), params);
}

inline void glGetVertexAttribiv(GLuint index, gl20::GLenum pname, GLint * params)
{
   	return FunctionObjects::GetVertexAttribiv(index, static_cast<gl::GLenum>(pname), params);
}

inline void glHint(gl20::GLenum target, gl20::GLenum mode)
{
...
inline void glIndexPointer(gl20::GLenum type, GLsizei stride, const void * pointer)
{
...
inline void glInterleavedArrays(gl20::GLenum format, GLsizei stride, const void * pointer)
{
...
inline GLboolean glIsEnabled(gl20::GLenum cap)
{
...
inline void glLogicOp(gl20::GLenum opcode)
{
   	return FunctionObjects::LogicOp(static_cast<gl::GLenum>(opcode));
}

inline void glMap1d(gl20::GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble * points)
{
   	return FunctionObjects::Map1d(static_cast<gl::GLenum>(target), u1, u2, stride, order, points);
}

inline void glMap1f(gl20::GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat * points)
{
   	return FunctionObjects::Map1f(static_cast<gl::GLenum>(target), u1, u2, stride, order, points);
}

inline void glMap2d(gl20::GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble * points)
{
   	return FunctionObjects::Map2d(static_cast<gl::GLenum>(target), u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
}

inline void glMap2f(gl20::GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat * points)
{
   	return FunctionObjects::Map2f(static_cast<gl::GLenum>(target), u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
}

inline void * glMapBuffer(gl20::GLenum target, gl20::GLenum access)
{
...
inline void glMultiDrawArrays(gl20::GLenum mode, const GLint * first, const GLsizei * count, GLsizei drawcount)
{
   	return FunctionObjects::MultiDrawArrays(static_cast<gl::GLenum>(mode), first, count, drawcount);
}

inline void glMultiDrawElements(gl20::GLenum mode, const GLsizei * count, gl20::GLenum type, const void *const* indices, GLsizei drawcount)
{
   	return FunctionObjects::MultiDrawElements(static_cast<gl::GLenum>(mode), count, static_cast<gl::GLenum>(type), indices, drawcount);
}

inline void glMultiTexCoord1d(gl20::GLenum target, GLdouble s)
{
   	return FunctionObjects::MultiTexCoord1d(static_cast<gl::GLenum>(target), s);
}

inline void glMultiTexCoord1dv(gl20::GLenum target, const GLdouble * v)
{
   	return FunctionObjects::MultiTexCoord1dv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord1f(gl20::GLenum target, GLfloat s)
{
   	return FunctionObjects::MultiTexCoord1f(static_cast<gl::GLenum>(target), s);
}

inline void glMultiTexCoord1fv(gl20::GLenum target, const GLfloat * v)
{
   	return FunctionObjects::MultiTexCoord1fv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord1i(gl20::GLenum target, GLint s)
{
   	return FunctionObjects::MultiTexCoord1i(static_cast<gl::GLenum>(target), s);
}

inline void glMultiTexCoord1iv(gl20::GLenum target, const GLint * v)
{
   	return FunctionObjects::MultiTexCoord1iv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord1s(gl20::GLenum target, GLshort s)
{
   	return FunctionObjects::MultiTexCoord1s(static_cast<gl::GLenum>(target), s);
}

inline void glMultiTexCoord1sv(gl20::GLenum target, const GLshort * v)
{
   	return FunctionObjects::MultiTexCoord1sv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord2d(gl20::GLenum target, GLdouble s, GLdouble t)
{
   	return FunctionObjects::MultiTexCoord2d(static_cast<gl::GLenum>(target), s, t);
}

inline void glMultiTexCoord2dv(gl20::GLenum target, const GLdouble * v)
{
   	return FunctionObjects::MultiTexCoord2dv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord2f(gl20::GLenum target, GLfloat s, GLfloat t)
{
   	return FunctionObjects::MultiTexCoord2f(static_cast<gl::GLenum>(target), s, t);
}

inline void glMultiTexCoord2fv(gl20::GLenum target, const GLfloat * v)
{
   	return FunctionObjects::MultiTexCoord2fv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord2i(gl20::GLenum target, GLint s, GLint t)
{
   	return FunctionObjects::MultiTexCoord2i(static_cast<gl::GLenum>(target), s, t);
}

inline void glMultiTexCoord2iv(gl20::GLenum target, const GLint * v)
{
   	return FunctionObjects::MultiTexCoord2iv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord2s(gl20::GLenum target, GLshort s, GLshort t)
{
   	return FunctionObjects::MultiTexCoord2s(static_cast<gl::GLenum>(target), s, t);
}

inline void glMultiTexCoord2sv(gl20::GLenum target, const GLshort * v)
{
   	return FunctionObjects::MultiTexCoord2sv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord3d(gl20::GLenum target, GLdouble s, GLdouble t, GLdouble r)
{
   	return FunctionObjects::MultiTexCoord3d(static_cast<gl::GLenum>(target), s, t, r);
}

inline void glMultiTexCoord3dv(gl20::GLenum target, const GLdouble * v)
{
   	return FunctionObjects::MultiTexCoord3dv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord3f(gl20::GLenum target, GLfloat s, GLfloat t, GLfloat r)
{
   	return FunctionObjects::MultiTexCoord3f(static_cast<gl::GLenum>(target), s, t, r);
}

inline void glMultiTexCoord3fv(gl20::GLenum target, const GLfloat * v)
{
   	return FunctionObjects::MultiTexCoord3fv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord3i(gl20::GLenum target, GLint s, GLint t, GLint r)
{
   	return FunctionObjects::MultiTexCoord3i(static_cast<gl::GLenum>(target), s, t, r);
}

inline void glMultiTexCoord3iv(gl20::GLenum target, const GLint * v)
{
   	return FunctionObjects::MultiTexCoord3iv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord3s(gl20::GLenum target, GLshort s, GLshort t, GLshort r)
{
   	return FunctionObjects::MultiTexCoord3s(static_cast<gl::GLenum>(target), s, t, r);
}

inline void glMultiTexCoord3sv(gl20::GLenum target, const GLshort * v)
{
   	return FunctionObjects::MultiTexCoord3sv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord4d(gl20::GLenum target, GLdouble s, GLdouble t, GLdouble r, GLdouble q)
{
   	return FunctionObjects::MultiTexCoord4d(static_cast<gl::GLenum>(target), s, t, r, q);
}

inline void glMultiTexCoord4dv(gl20::GLenum target, const GLdouble * v)
{
   	return FunctionObjects::MultiTexCoord4dv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord4f(gl20::GLenum target, GLfloat s, GLfloat t, GLfloat r, GLfloat q)
{
   	return FunctionObjects::MultiTexCoord4f(static_cast<gl::GLenum>(target), s, t, r, q);
}

inline void glMultiTexCoord4fv(gl20::GLenum target, const GLfloat * v)
{
   	return FunctionObjects::MultiTexCoord4fv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord4i(gl20::GLenum target, GLint s, GLint t, GLint r, GLint q)
{
   	return FunctionObjects::MultiTexCoord4i(static_cast<gl::GLenum>(target), s, t, r, q);
}

inline void glMultiTexCoord4iv(gl20::GLenum target, const GLint * v)
{
   	return FunctionObjects::MultiTexCoord4iv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord4s(gl20::GLenum target, GLshort s, GLshort t, GLshort r, GLshort q)
{
   	return FunctionObjects::MultiTexCoord4s(static_cast<gl::GLenum>(target), s, t, r, q);
}

inline void glMultiTexCoord4sv(gl20::GLenum target, const GLshort * v)
{
   	return FunctionObjects::MultiTexCoord4sv(static_cast<gl::GLenum>(target), v);
}

inline void glMultiTexCoord4x(gl20::GLenum texture, GLfixed s, GLfixed t, GLfixed r, GLfixed q)
{
   	return FunctionObjects::MultiTexCoord4x(static_cast<gl::GLenum>(texture), s, t, r, q);
}

inline void glNewList(GLuint list, gl20::GLenum mode)
{
...
inline void glNormalPointer(gl20::GLenum type, GLsizei stride, const void * pointer)
{
...
inline void glPixelMapfv(gl20::GLenum map, GLsizei mapsize, const GLfloat * values)
{
   	return FunctionObjects::PixelMapfv(static_cast<gl::GLenum>(map), mapsize, values);
}

inline void glPixelMapuiv(gl20::GLenum map, GLsizei mapsize, const GLuint * values)
{
   	return FunctionObjects::PixelMapuiv(static_cast<gl::GLenum>(map), mapsize, values);
}

inline void glPixelMapusv(gl20::GLenum map, GLsizei mapsize, const GLushort * values)
{
   	return FunctionObjects::PixelMapusv(static_cast<gl::GLenum>(map), mapsize, values);
}

inline void glPixelStoref(gl20::GLenum pname, GLfloat param)
{
   	return FunctionObjects::PixelStoref(static_cast<gl::GLenum>(pname), param);
}

inline void glPixelStorei(gl20::GLenum pname, GLint param)
{
   	return FunctionObjects::PixelStorei(static_cast<gl::GLenum>(pname), param);
}

inline void glPixelTransferf(gl20::GLenum pname, GLfloat param)
{
   	return FunctionObjects::PixelTransferf(static_cast<gl::GLenum>(pname), param);
}

inline void glPixelTransferi(gl20::GLenum pname, GLint param)
{
...
inline void glPointParameterf(gl20::GLenum pname, GLfloat param)
{
   	return FunctionObjects::PointParameterf(static_cast<gl::GLenum>(pname), param);
}

inline void glPointParameterfv(gl20::GLenum pname, const GLfloat * params)
{
   	return FunctionObjects::PointParameterfv(static_cast<gl::GLenum>(pname), params);
}

inline void glPointParameteri(gl20::GLenum pname, GLint param)
{
   	return FunctionObjects::PointParameteri(static_cast<gl::GLenum>(pname), param);
}

inline void glPointParameteriv(gl20::GLenum pname, const GLint * params)
{
   	return FunctionObjects::PointParameteriv(static_cast<gl::GLenum>(pname), params);
}

inline void glPointParameterx(gl20::GLenum pname, GLfixed param)
{
   	return FunctionObjects::PointParameterx(static_cast<gl::GLenum>(pname), param);
}

inline void glPointParameterxv(gl20::GLenum pname, const GLfixed * params)
{
...
inline void glPolygonMode(gl20::GLenum face, gl20::GLenum mode)
{
...
inline void glPushAttrib(gl20::GLbitfield mask)
{
   	return FunctionObjects::PushAttrib(static_cast<gl::GLbitfield>(mask));
}

inline void glPushClientAttrib(gl20::GLbitfield mask)
{
...
inline void glReadBuffer(gl20::GLenum mode)
{
   	return FunctionObjects::ReadBuffer(static_cast<gl::GLenum>(mode));
}

inline void glReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, gl20::GLenum format, gl20::GLenum type, void * pixels)
{
...
inline GLint glRenderMode(gl20::GLenum mode)
{
...
inline void glSecondaryColorPointer(GLint size, gl20::GLenum type, GLsizei stride, const void * pointer)
{
...
inline void glShadeModel(gl20::GLenum mode)
{
...
inline void glStencilFunc(gl20::GLenum func, GLint ref, GLuint mask)
{
   	return FunctionObjects::StencilFunc(static_cast<gl::GLenum>(func), ref, mask);
}

inline void glStencilFuncSeparate(gl20::GLenum face, gl20::GLenum func, GLint ref, GLuint mask)
{
...
inline void glStencilMaskSeparate(gl20::GLenum face, GLuint mask)
{
   	return FunctionObjects::StencilMaskSeparate(static_cast<gl::GLenum>(face), mask);
}

inline void glStencilOp(gl20::GLenum fail, gl20::GLenum zfail, gl20::GLenum zpass)
{
   	return FunctionObjects::StencilOp(static_cast<gl::GLenum>(fail), static_cast<gl::GLenum>(zfail), static_cast<gl::GLenum>(zpass));
}

inline void glStencilOpSeparate(gl20::GLenum face, gl20::GLenum sfail, gl20::GLenum dpfail, gl20::GLenum dppass)
{
...
inline void glTexImage2D(gl20::GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, gl20::GLenum format, gl20::GLenum type, const void * pixels)
{
...
inline void glTexImage3D(gl20::GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, gl20::GLenum format, gl20::GLenum type, const void * pixels)
{
...
inline void glTexParameterf(gl20::GLenum target, gl20::GLenum pname, GLfloat param)
{
   	return FunctionObjects::TexParameterf(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexParameterfv(gl20::GLenum target, gl20::GLenum pname, const GLfloat * params)
{
   	return FunctionObjects::TexParameterfv(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), params);
}

inline void glTexParameteri(gl20::GLenum target, gl20::GLenum pname, GLint param)
{
   	return FunctionObjects::TexParameteri(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexParameteriv(gl20::GLenum target, gl20::GLenum pname, const GLint * params)
{
   	return FunctionObjects::TexParameteriv(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), params);
}

inline void glTexParameterx(gl20::GLenum target, gl20::GLenum pname, GLfixed param)
{
   	return FunctionObjects::TexParameterx(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), param);
}

inline void glTexParameterxv(gl20::GLenum target, gl20::GLenum pname, const GLfixed * params)
{
   	return FunctionObjects::TexParameterxv(static_cast<gl::GLenum>(target), static_cast<gl::GLenum>(pname), params);
}

inline void glTexSubImage1D(gl20::GLenum target, GLint level, GLint xoffset, GLsizei width, gl20::GLenum format, gl20::GLenum type, const void * pixels)
{
...
inline void glTexSubImage2D(gl20::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, gl20::GLenum format, gl20::GLenum type, const void * pixels)
{
...
inline void glTexSubImage3D(gl20::GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, gl20::GLenum format, gl20::GLenum type, const void * pixels)
{
...
inline GLboolean glUnmapBuffer(gl20::GLenum target)
{
...
inline void glVertexAttribPointer(GLuint index, GLint size, gl20::GLenum type, GLboolean normalized, GLsizei stride, const void * pointer)
{
   	return FunctionObjects::VertexAttribPointer(index, size, static_cast<gl::GLenum>(type), normalized, stride, pointer);
}

inline void glVertexPointer(GLint size, gl20::GLenum type, GLsizei stride, const void * pointer)
{
