...
{
    return static_cast<gl44ext::GLenum>(glbinding::FunctionObjects::current().glCheckFramebufferStatusEXT(target));
}

inline GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return static_cast<gl44ext::GLenum>(glbinding::FunctionObjects::current().glCheckNamedFramebufferStatusEXT(framebuffer, target));
}
...
{
    return static_cast<gl44ext::GLenum>(glbinding::FunctionObjects::current().glGetGraphicsResetStatusARB());
}
...
{
    return static_cast<gl44ext::GLenum>(glbinding::FunctionObjects::current().glObjectPurgeableAPPLE(objectType, name, option));
}

inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return static_cast<gl44ext::GLenum>(glbinding::FunctionObjects::current().glObjectUnpurgeableAPPLE(objectType, name, option));
}
...
{
    return static_cast<gl44ext::GLenum>(glbinding::FunctionObjects::current().glPathGlyphIndexArrayNV(firstPathName, fontTarget, fontName, fontStyle, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale));
}
...
{
    return static_cast<gl44ext::GLenum>(glbinding::FunctionObjects::current().glPathGlyphIndexRangeNV(fontTarget, fontName, fontStyle, pathParameterTemplate, emScale, baseAndCount));
}
...
{
    return static_cast<gl44ext::GLenum>(glbinding::FunctionObjects::current().glPathMemoryGlyphIndexArrayNV(firstPathName, fontTarget, fontSize, fontData, faceIndex, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale));
}
...
{
    return static_cast<gl44ext::GLbitfield>(glbinding::FunctionObjects::current().glQueryMatrixxOES(mantissa, exponent));
}
...
{
    return static_cast<gl44ext::GLenum>(glbinding::FunctionObjects::current().glVideoCaptureNV(video_capture_slot, sequence_num, capture_time));
}
