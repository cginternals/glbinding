...
{
    return static_cast<gl40::GLenum>(glbinding::FunctionObjects::CheckFramebufferStatus(target));
}
...
{
    return static_cast<gl40::GLenum>(glbinding::FunctionObjects::ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl40::GLenum>(glbinding::FunctionObjects::GetError());
}
