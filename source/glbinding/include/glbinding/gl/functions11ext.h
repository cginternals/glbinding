...
{
    return static_cast<gl11ext::GLenum>(glbinding::FunctionObjects::CheckFramebufferStatus(target));
}

inline GLenum glCheckFramebufferStatusEXT(GLenum target)
{
    return static_cast<gl11ext::GLenum>(glbinding::FunctionObjects::CheckFramebufferStatusEXT(target));
}

inline GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return static_cast<gl11ext::GLenum>(glbinding::FunctionObjects::CheckNamedFramebufferStatusEXT(framebuffer, target));
}
...
{
    return static_cast<gl11ext::GLenum>(glbinding::FunctionObjects::ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl11ext::GLenum>(glbinding::FunctionObjects::GetGraphicsResetStatusARB());
}
...
{
    return static_cast<gl11ext::GLenum>(glbinding::FunctionObjects::ObjectPurgeableAPPLE(objectType, name, option));
}

inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return static_cast<gl11ext::GLenum>(glbinding::FunctionObjects::ObjectUnpurgeableAPPLE(objectType, name, option));
}
...
{
    return static_cast<gl11ext::GLbitfield>(glbinding::FunctionObjects::QueryMatrixxOES(mantissa, exponent));
}
...
{
    return static_cast<gl11ext::GLenum>(glbinding::FunctionObjects::VideoCaptureNV(video_capture_slot, sequence_num, capture_time));
}
