...
{
    return static_cast<gl41core::GLenum>(glbinding::FunctionObjects::CheckFramebufferStatus(target));
}
...
{
    return static_cast<gl41core::GLenum>(glbinding::FunctionObjects::ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl41core::GLenum>(glbinding::FunctionObjects::GetError());
}
