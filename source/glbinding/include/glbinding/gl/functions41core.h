...
{
    return static_cast<gl41core::GLenum>(glbinding::FunctionObjects::current().glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl41core::GLenum>(glbinding::FunctionObjects::current().glClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl41core::GLenum>(glbinding::FunctionObjects::current().glGetError());
}
