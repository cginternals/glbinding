...
{
    return static_cast<gl33::GLenum>(glbinding::currentBinding().glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl33::GLenum>(glbinding::currentBinding().glClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl33::GLenum>(glbinding::currentBinding().glGetError());
}
