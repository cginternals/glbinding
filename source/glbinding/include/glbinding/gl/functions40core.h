...
{
    return static_cast<gl40core::GLenum>(glbinding::currentBinding().glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl40core::GLenum>(glbinding::currentBinding().glClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl40core::GLenum>(glbinding::currentBinding().glGetError());
}
