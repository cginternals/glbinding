...
{
    return glbinding::FunctionObjects::current().CheckFramebufferStatus(target);
}

inline GLenum glCheckFramebufferStatusEXT(GLenum target)
{
    return glbinding::FunctionObjects::current().CheckFramebufferStatusEXT(target);
}

inline GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return glbinding::FunctionObjects::current().CheckNamedFramebufferStatusEXT(framebuffer, target);
}
...
{
    return glbinding::FunctionObjects::current().ClientWaitSync(sync, flags, timeout);
}
...
{
    return glbinding::FunctionObjects::current().GetError();
}
...
{
    return glbinding::FunctionObjects::current().GetGraphicsResetStatusARB();
}
...
{
    return glbinding::FunctionObjects::current().ObjectPurgeableAPPLE(objectType, name, option);
}

inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return glbinding::FunctionObjects::current().ObjectUnpurgeableAPPLE(objectType, name, option);
}
...
{
    return glbinding::FunctionObjects::current().QueryMatrixxOES(mantissa, exponent);
}
...
{
    return glbinding::FunctionObjects::current().VideoCaptureNV(video_capture_slot, sequence_num, capture_time);
}
