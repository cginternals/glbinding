...
{
    return glbinding::FunctionObjects::current().glCheckFramebufferStatus(target);
}

inline GLenum glCheckFramebufferStatusEXT(GLenum target)
{
    return glbinding::FunctionObjects::current().glCheckFramebufferStatusEXT(target);
}

inline GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return glbinding::FunctionObjects::current().glCheckNamedFramebufferStatusEXT(framebuffer, target);
}
...
{
    return glbinding::FunctionObjects::current().glClientWaitSync(sync, flags, timeout);
}
...
{
    return glbinding::FunctionObjects::current().glGetError();
}
...
{
    return glbinding::FunctionObjects::current().glGetGraphicsResetStatusARB();
}
...
{
    return glbinding::FunctionObjects::current().glObjectPurgeableAPPLE(objectType, name, option);
}

inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return glbinding::FunctionObjects::current().glObjectUnpurgeableAPPLE(objectType, name, option);
}
...
{
    return glbinding::FunctionObjects::current().glPathGlyphIndexArrayNV(firstPathName, fontTarget, fontName, fontStyle, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale);
}
...
{
    return glbinding::FunctionObjects::current().glPathGlyphIndexRangeNV(fontTarget, fontName, fontStyle, pathParameterTemplate, emScale, baseAndCount);
}
...
{
    return glbinding::FunctionObjects::current().glPathMemoryGlyphIndexArrayNV(firstPathName, fontTarget, fontSize, fontData, faceIndex, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale);
}
...
{
    return glbinding::FunctionObjects::current().glQueryMatrixxOES(mantissa, exponent);
}
...
{
    return glbinding::FunctionObjects::current().glVideoCaptureNV(video_capture_slot, sequence_num, capture_time);
}
