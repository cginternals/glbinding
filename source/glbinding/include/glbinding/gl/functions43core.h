...
{
    return static_cast<gl43core::GLenum>(glbinding::FunctionObjects::current().CheckFramebufferStatus(target));
}
...
{
    return static_cast<gl43core::GLenum>(glbinding::FunctionObjects::current().ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl43core::GLenum>(glbinding::FunctionObjects::current().GetError());
}
