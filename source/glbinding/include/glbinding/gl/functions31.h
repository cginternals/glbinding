...
{
    return static_cast<gl31::GLenum>(glbinding::FunctionObjects::current().glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl31::GLenum>(glbinding::FunctionObjects::current().glGetError());
}
