...
{
    return static_cast<gl31::GLenum>(glbinding::FunctionObjects::current().CheckFramebufferStatus(target));
}
...
{
    return static_cast<gl31::GLenum>(glbinding::FunctionObjects::current().GetError());
}
