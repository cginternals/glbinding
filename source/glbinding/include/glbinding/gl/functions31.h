...
{
    return static_cast<gl31::GLenum>(glbinding::FunctionObjects::CheckFramebufferStatus(target));
}
...
{
    return static_cast<gl31::GLenum>(glbinding::FunctionObjects::GetError());
}
