...
{
    return static_cast<gl41::GLenum>(glbinding::FunctionObjects::current().CheckFramebufferStatus(target));
}
...
{
    return static_cast<gl41::GLenum>(glbinding::FunctionObjects::current().ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl41::GLenum>(glbinding::FunctionObjects::current().GetError());
}
