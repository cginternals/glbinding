...
{
    return static_cast<gl42::GLenum>(glbinding::FunctionObjects::current().CheckFramebufferStatus(target));
}
...
{
    return static_cast<gl42::GLenum>(glbinding::FunctionObjects::current().ClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl42::GLenum>(glbinding::FunctionObjects::current().GetError());
}
