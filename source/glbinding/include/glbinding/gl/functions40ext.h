...
{
    return static_cast<gl40ext::GLenum>(glbinding::FunctionObjects::current().CheckFramebufferStatusEXT(target));
}

inline GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return static_cast<gl40ext::GLenum>(glbinding::FunctionObjects::current().CheckNamedFramebufferStatusEXT(framebuffer, target));
}
...
{
    return static_cast<gl40ext::GLenum>(glbinding::FunctionObjects::current().GetGraphicsResetStatusARB());
}
...
{
    return static_cast<gl40ext::GLenum>(glbinding::FunctionObjects::current().ObjectPurgeableAPPLE(objectType, name, option));
}

inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return static_cast<gl40ext::GLenum>(glbinding::FunctionObjects::current().ObjectUnpurgeableAPPLE(objectType, name, option));
}
...
{
    return static_cast<gl40ext::GLbitfield>(glbinding::FunctionObjects::current().QueryMatrixxOES(mantissa, exponent));
}
...
{
    return static_cast<gl40ext::GLenum>(glbinding::FunctionObjects::current().VideoCaptureNV(video_capture_slot, sequence_num, capture_time));
}
