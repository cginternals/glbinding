...
{
    return static_cast<gl42ext::GLenum>(glbinding::currentBinding().glCheckFramebufferStatusEXT(target));
}

inline GLenum glCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target)
{
    return static_cast<gl42ext::GLenum>(glbinding::currentBinding().glCheckNamedFramebufferStatusEXT(framebuffer, target));
}
...
{
    return static_cast<gl42ext::GLenum>(glbinding::currentBinding().glGetGraphicsResetStatusARB());
}
...
{
    return static_cast<gl42ext::GLenum>(glbinding::currentBinding().glObjectPurgeableAPPLE(objectType, name, option));
}

inline GLenum glObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option)
{
    return static_cast<gl42ext::GLenum>(glbinding::currentBinding().glObjectUnpurgeableAPPLE(objectType, name, option));
}
...
{
    return static_cast<gl42ext::GLenum>(glbinding::currentBinding().glPathGlyphIndexArrayNV(firstPathName, fontTarget, fontName, fontStyle, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale));
}
...
{
    return static_cast<gl42ext::GLenum>(glbinding::currentBinding().glPathGlyphIndexRangeNV(fontTarget, fontName, fontStyle, pathParameterTemplate, emScale, baseAndCount));
}
...
{
    return static_cast<gl42ext::GLenum>(glbinding::currentBinding().glPathMemoryGlyphIndexArrayNV(firstPathName, fontTarget, fontSize, fontData, faceIndex, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale));
}
...
{
    return static_cast<gl42ext::GLbitfield>(glbinding::currentBinding().glQueryMatrixxOES(mantissa, exponent));
}
...
{
    return static_cast<gl42ext::GLenum>(glbinding::currentBinding().glVideoCaptureNV(video_capture_slot, sequence_num, capture_time));
}
