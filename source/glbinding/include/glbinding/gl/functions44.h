...
{
    return static_cast<gl44::GLenum>(glbinding::FunctionObjects::current().glCheckFramebufferStatus(target));
}
...
{
    return static_cast<gl44::GLenum>(glbinding::FunctionObjects::current().glClientWaitSync(sync, flags, timeout));
}
...
{
    return static_cast<gl44::GLenum>(glbinding::FunctionObjects::current().glGetError());
}
