...
REM python scripts/generate.py -a wgl -p wgl -l wgl -s wgl.xml -r wgl.revision -x wglpatch.xml
REM python scripts/generate.py -a glx -p glx -l glx -s glx.xml -r glx.revision -x glxpatch.xml
