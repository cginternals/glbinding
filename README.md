...
glbinding-1.0.3 was just released: [goto release](https://github.com/hpicgs/glbinding/releases/tag/v1.0.3)
glbinding is a cross-platform library licenced under the [MIT license](http://opensource.org/licenses/MIT).
